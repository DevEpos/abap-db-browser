"! <p class="shorttext synchronized">Starts screen for DB Browser</p>
CLASS zcl_dbbr_app_starter DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.

  PUBLIC SECTION.
    "! <p class="shorttext synchronized">Start new DB Browser selection from memory</p>
...
CLASS zcl_dbbr_app_starter IMPLEMENTATION.
  METHOD start_selection_from_memory.
    ...
    IF ls_controller_data IS INITIAL.
      RETURN.
    ENDIF.

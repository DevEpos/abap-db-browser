"! <p class="shorttext synchronized">Repository tree for Navigator</p>
CLASS zcl_dbbr_object_browser_tree DEFINITION
  ...
  PUBLIC SECTION.
    ...
    ALIASES c_node_type FOR zif_dbbr_c_object_browser~c_tree_node_type.
    ALIASES focus       FOR zif_uitb_gui_control~focus.
    ALIASES has_focus   FOR zif_uitb_gui_control~has_focus.
  ...
  PRIVATE SECTION.
    ...
    "! <p class="shorttext synchronized">Clears tree of all nodes</p>
    "!
    METHODS clear_tree.

    "! <p class="shorttext synchronized">Create sub nodes of database table/view</p>
    ...
    "! <p class="shorttext synchronized">Create input controls for search type and entity</p>
    "! @parameter iv_initial_value | <p class="shorttext synchronized">the initial value</p>
    METHODS create_input_dd
      IMPORTING
        iv_initial_value TYPE string OPTIONAL.

    "! <p class="shorttext synchronized">Create tree for multiple cds views</p>
    "!
    ...
    "! <p class="shorttext synchronized">Create tree for multiple packages</p>
    "!
    ...
    "! <p class="shorttext synchronized">Create query sub tree</p>
    "!
    ...
    "! <p class="shorttext synchronized">Create query tree</p>
    "!
    METHODS create_query_tree
      IMPORTING
        it_queries TYPE zsat_entity_t.

    "! <p class="shorttext synchronized">Create tree for single cds view</p>
    "!
    ...
    "! <p class="shorttext synchronized">Create tree for single table/view</p>
    "!
    METHODS create_single_db_tab_tree
      IMPORTING
        is_table_info TYPE zsat_entity.

    "! <p class="shorttext synchronized">Build Tree for a single package</p>
    "!
    ...
    "! <p class="shorttext synchronized">Creates splitter</p>
    METHODS create_splitter.

    "! <p class="shorttext synchronized">Create sub nodes for single CDS node</p>
    "!
    ...
    "! <p class="shorttext synchronized">Creates Tree</p>
    "!
    METHODS create_tree
      RAISING
        zcx_uitb_tree_error.

    "! <p class="shorttext synchronized">Expand a single CDS View</p>
    "!
    ...
    "! <p class="shorttext synchronized">Expand db tabs subnode of package node</p>
    "!
    ...
    "! <p class="shorttext synchronized">Expand ddls subnode of package node</p>
    "!
    ...
    "! <p class="shorttext synchronized">Expand the package</p>
    "!
    ...
    "! <p class="shorttext synchronized">Expand views subnode of package node</p>
    "!
    ...
    "! <p class="shorttext synchronized">Expand a single Query</p>
    "!
    ...
    "! <p class="shorttext synchronized">Expand a single Database view</p>
    "!
    ...
    "! <p class="shorttext synchronized">Create foreign key table nodes for the given table</p>
    ...
    "! <p class="shorttext synchronized">Expands properties node of db table/view</p>
    ...
    "! <p class="shorttext synchronized">Expand technical settings node of db table node</p>
    METHODS expand_tech_settings_node
      IMPORTING
        iv_tabname  TYPE tabname
        iv_node_key TYPE tm_nodekey.

    "! <p class="shorttext synchronized">Fill favorites dropdown</p>
    "!
    ...
    "! <p class="shorttext synchronized">Handler for DISPLAY_OBJECT_LIST event</p>
    "!
    ...
    "! <p class="shorttext synchronized">Handler for External object search request</p>
    "!
    ...
    "! <p class="shorttext synchronized">Handler for performing the search</p>
    "!
    METHODS on_perform_search
      FOR EVENT clicked OF cl_dd_button_element.

    "! <p class="shorttext synchronized">Enter Handler for search input</p>
    "!
    METHODS on_search_input_enter
      FOR EVENT entered OF cl_dd_input_element.

    "! <p class="shorttext synchronized">Dropdown Selection changed handler</p>
    "!
    ...
    "! <p class="shorttext synchronized">Show superordinate tree of current object</p>
    "!
    METHODS show_superordinate_tree.

    "! <p class="shorttext synchronized">Trigger a new search</p>
    "!
    METHODS trigger_new_search
      RETURNING
        VALUE(rf_success) TYPE abap_bool.

    "! <p class="shorttext synchronized">Update toolbar for tree</p>
    "!
    METHODS update_toolbar
      IMPORTING
        if_multiple_tree TYPE abap_bool OPTIONAL.

    "! <p class="shorttext synchronized">Trigger my object search for objects of current user</p>
    "!
    METHODS trigger_my_objects_search
      IMPORTING
        iv_fcode TYPE ui_func.

    "! <p class="shorttext synchronized">Exports the selected queries</p>
    "!
    METHODS export_queries.

    "! <p class="shorttext synchronized">Trigger query from history</p>
    "!
    METHODS show_historic_query.
    "! <p class="shorttext synchronized">Adds new historic entry</p>
    "!
    METHODS add_history_entry.

    "! <p class="shorttext synchronized">Update status of history navigation buttons</p>
    METHODS update_history_buttons.
    "! <p class="shorttext synchronized">Navigate to previous history entry</p>
    METHODS go_to_previous_historic_entry.
    "! <p class="shorttext synchronized">Navigate to next history entry</p>
    ...
    "! <p class="shorttext synchronized">Edit search favorites of Object Browser</p>
    METHODS edit_favorites.
    "! <p class="shorttext synchronized">Add current query to search favorites</p>
    METHODS add_favorite.

    "! <p class="shorttext synchronized">Trigger query execution from favorite entry</p>
    METHODS trigger_query_from_favorite
      IMPORTING
        iv_function TYPE ui_func.

    "! <p class="shorttext synchronized">Show result count message in status bar</p>
    METHODS show_results_message
      IMPORTING
        iv_result_count TYPE i
        iv_max_count    TYPE i.

    "! <p class="shorttext synchronized">Check if the given node type is a package sub node</p>
    ...
    "! <p class="shorttext synchronized">Adapt html input and display doc</p>
    METHODS adapt_and_display_html_inp
      IMPORTING
        if_assign_parent TYPE abap_bool OPTIONAL.

    "! <p class="shorttext synchronized">Updates the search settings menu</p>
...
CLASS zcl_dbbr_object_browser_tree IMPLEMENTATION.
  METHOD class_constructor.
    ...
    gt_api_state_texts = VALUE #(
        FOR api IN lt_api_states
        ( api_state = api-name description = api-description )
  ...
  METHOD adapt_and_display_html_inp.
    ...
    LOOP AT mo_input_dd->html_table ASSIGNING FIELD-SYMBOL(<html>) WHERE line CS `<body`.
      <html>-line = replace( val  = <html>-line
                             sub  = `<body`
                             with = `<body scroll="no"` ).
      EXIT.
    ENDLOOP.
    ...
    IF if_assign_parent = abap_true.
      mo_html_control = NEW cl_gui_html_viewer( parent = mo_splitter->get_container( 1 ) ).
      mo_input_dd->html_control = mo_html_control.
      mo_input_dd->html_control->set_ui_flag( cl_gui_html_viewer=>uiflag_no3dborder +
    ...
    mo_input_dd->display_document( reuse_control      = abap_true
  ...
  METHOD constructor.
    ...
    TRY.
      ...
      CATCH zcx_uitb_tree_error INTO DATA(lx_tree_error).
        lx_tree_error->zif_uitb_exception_message~print( iv_msg_type = 'X' ).
    ENDTRY.
    create_input_dd( ).

    SET HANDLER on_display_object_list.
    SET HANDLER on_external_object_search_req.
  ...
  METHOD create_input_dd.
    ...
    DATA(lo_s_global_data) = CAST zdbbr_global_data( zcl_uitb_data_cache=>get_instance( zif_dbbr_c_report_id=>main )->get_data_ref(
                                                         zif_dbbr_main_report_var_ids=>c_s_data ) ).

    mo_input_dd->initialize_document( no_margins = abap_true ).

    " .. Fill the document
    mo_input_dd->add_form( IMPORTING formarea = DATA(lo_form) ).
    lo_form->line_with_layout( start            = abap_true
                               no_leading_break = abap_true ).
    lo_form->add_select_element(
      EXPORTING tooltip        = |{ 'Object Category'(006) }|
                options        = VALUE #(
    ...
    lo_form->line_with_layout( start            = abap_true
                               no_leading_break = abap_true ).
    lo_form->add_input_element( EXPORTING size          = 50    " Length of Input Field
                                          tooltip       = |{ 'Enter name of Entity'(004) }|
                                          maxlength     = 200    " Maximum Permitted Text Entry Length
                                IMPORTING input_element = mo_search_input ).
    mo_search_input->set_value( |{ iv_initial_value }| ).

    lo_form->add_button( EXPORTING sap_icon = |ICON_DISPLAY|
                                   tooltip  = |{ 'Perform search'(007) }|
                         IMPORTING button   = DATA(lo_search_button) ).

    lo_form->line_with_layout( end = abap_true ).

    " .. Register event handlers for form elements
    SET HANDLER on_search_input_enter FOR mo_search_input.
    SET HANDLER on_perform_search FOR lo_search_button.
    SET HANDLER on_search_type_selected FOR mo_search_type_select.
  ...
  METHOD create_multiple_cds_view_tree.
    ...
    LOOP AT it_cds_view_header ASSIGNING FIELD-SYMBOL(<ls_cds_header>).
      ...
      DATA(lo_cds_view_node) = create_node(
          ...
          is_hier2_item      = VALUE #( style = zif_uitb_c_ctm_style=>inverted_gray
                                        text  = <ls_cds_header>-description )
          ir_user_data       = NEW ty_s_user_data( entity_id     = <ls_cds_header>-entity_id
  ...
  METHOD create_multiple_db_tab_tree.
    ...
    LOOP AT it_table_definition ASSIGNING FIELD-SYMBOL(<ls_tabname>).
      ...
      DATA(lo_table_node) = create_node(
          ...
          is_hier2_item      = VALUE #( text  = <ls_tabname>-description
                                        style = zif_uitb_c_ctm_style=>inverted_gray )
          ir_user_data       = NEW ty_s_user_data( entity_id = <ls_tabname>-entity_id
                                                   node_type = lv_node_type ) ).

      create_db_table_subnodes( io_db_tab_view_node = lo_table_node
  ...
  METHOD create_db_table_subnodes.
    ...
    DATA(lo_properties_node) = create_node(
                                   ...
                                   ir_user_data       = NEW ty_s_user_data(
                                       ...
                                       node_type = COND #( WHEN is_entity-entity_type = zif_sat_c_entity_type=>view
                                                           THEN c_node_type-view_properties
                                                           ELSE c_node_type-dbtable_properties ) ) ).

    IF is_entity-entity_type = zif_sat_c_entity_type=>table.
      create_node( iv_parent_node     = io_db_tab_view_node->mv_node_key
                   if_folder          = abap_true
                   if_expander        = abap_true
                   iv_hier1_item_text = |{ 'Technical Settings'(037) }|
                   ir_user_data       = NEW ty_s_user_data( entity_id = is_entity-entity_id
  ...
  METHOD create_multiple_package_tree.
    ...
    LOOP AT it_package_def ASSIGNING FIELD-SYMBOL(<ls_package>).
      " TODO: variable is assigned but never used (ABAP cleaner)
      DATA(lo_package_node) = create_node( if_folder          = abap_true
                                           iv_image           = zif_dbbr_c_icon=>package
                                           if_expander        = abap_true
                                           iv_hier1_item_text = |{ <ls_package>-package }|
                                           is_hier2_item      = VALUE #( style = zif_uitb_c_ctm_style=>inverted_gray
                                                                         text  = <ls_package>-ddtext )
                                           ir_user_data       = NEW ty_s_user_data( entity_id = <ls_package>-package
  ...
  METHOD create_query_sub_tree.
    expand_query_node( iv_query    = iv_query
  ...
  METHOD create_query_tree.
    ...
    LOOP AT it_queries ASSIGNING FIELD-SYMBOL(<ls_query>).
      DATA(lo_query_node) = create_node( if_folder          = abap_true
                                         iv_image           = zif_dbbr_c_icon=>query
                                         if_expander        = abap_true
                                         iv_hier1_item_text = |{ <ls_query>-entity_id }|
                                         is_hier2_item      = VALUE #( style = zif_uitb_c_ctm_style=>inverted_gray
                                                                       text  = <ls_query>-description )
                                         ir_user_data       = NEW ty_s_user_data( entity_id = <ls_query>-entity_id
                                                                                  node_type = c_node_type-query ) ).

      IF lines( it_queries ) = 1.
        create_query_sub_tree( iv_query      = <ls_query>-entity_id
  ...
  METHOD create_single_cds_view_tree.
    ...
    IF lo_cds_view_node IS INITIAL.
      ...
      lo_cds_view_node = create_node( if_folder          = abap_true
                                      iv_image           = zif_dbbr_c_icon=>cds_view
                                      iv_hier1_item_text = |{ lv_cds_name_raw }|
                                      is_hier2_item      = VALUE #( style = zif_uitb_c_ctm_style=>inverted_gray
                                                                    text  = io_cds_view->get_description( ) )
                                      ir_user_data       = NEW ty_s_user_data( entity_id     = io_cds_view->mv_view_name
                                                                               entity_id_raw = lv_cds_name_raw
                                                                               node_type     = c_node_type-cds_view ) ).
    ENDIF.

    " .. Create Sub nodes
    create_subnodes_for_cds( io_cds_view      = io_cds_view
                             io_cds_view_node = lo_cds_view_node ).

    lo_nodes->expand_node( iv_node_key = lo_cds_view_node->mv_node_key ).
  ENDMETHOD.
  ...
  METHOD create_single_db_tab_tree.
    ...
    DATA(lo_table_node) = create_node( if_folder          = abap_true
                                       iv_image           = lv_node_image
                                       iv_hier1_item_text = |{ is_table_info-entity_id }|
                                       is_hier2_item      = VALUE #( style = zif_uitb_c_ctm_style=>inverted_gray
                                                                     text  = is_table_info-description )
                                       ir_user_data       = NEW ty_s_user_data( entity_id = is_table_info-entity_id
                                                                                node_type = lv_node_type ) ).
  ...
  METHOD create_single_package_tree.
    ...
    IF lo_package_node IS INITIAL.
      ...
      lo_package_node = create_node( if_folder          = abap_true
                                     iv_image           = zif_dbbr_c_icon=>package
                                     iv_hier1_item_text = |{ io_package->package_name }|
                                     is_hier2_item      = VALUE #( style = zif_uitb_c_ctm_style=>inverted_gray
                                                                   text  = io_package->short_text )
                                     ir_user_data       = NEW ty_s_user_data( entity_id = io_package->package_name
                                                                              node_type = c_node_type-package ) ).
    ENDIF.

    " .. Add sub nodes for subpackages, cds view, views and database tables
    io_package->get_sub_packages( IMPORTING  e_sub_packages = DATA(lt_sub_packages)
                                  EXCEPTIONS OTHERS         = 1 ).
    IF lt_sub_packages IS NOT INITIAL.
      LOOP AT lt_sub_packages ASSIGNING FIELD-SYMBOL(<lo_subpackage>).
        ...
        DATA(lo_subpackage_node) = create_node(
            ...
            ir_user_data       = NEW ty_s_user_data( entity_id = <lo_subpackage>->package_name
                                                     node_type = c_node_type-package ) ).
      ENDLOOP.
    ENDIF.

    io_package->get_elements( IMPORTING  e_elements = DATA(lt_elements)
                              EXCEPTIONS OTHERS     = 1 ).
    ...
    IF lf_has_ddls = abap_true.
      " TODO: variable is assigned but never used (ABAP cleaner)
      DATA(lo_cdsviews_node) = create_node( if_folder          = abap_true
                                            iv_parent_node     = lo_package_node->mv_node_key
                                            if_expander        = abap_true
    ...
    IF line_exists( lt_entity_count_in_package[ type = zif_sat_c_entity_type=>view ] ).
      " TODO: variable is assigned but never used (ABAP cleaner)
      DATA(lo_views_node) = create_node( if_folder          = abap_true
                                         iv_parent_node     = lo_package_node->mv_node_key
                                         if_expander        = abap_true
    ...
    IF line_exists( lt_entity_count_in_package[ type = zif_sat_c_entity_type=>table ] ).
      " TODO: variable is assigned but never used (ABAP cleaner)
      DATA(lo_database_tables_node) = create_node( if_folder          = abap_true
                                                   iv_parent_node     = lo_package_node->mv_node_key
                                                   if_expander        = abap_true
  ...
  METHOD create_subnodes_for_cds.
    DATA lv_node_type TYPE i.
    DATA lo_api_states_parent_node TYPE REF TO zcl_uitb_ctm_node.
    DATA lv_node_image TYPE tv_image.
    ...
    DATA(lo_cds_properties_node) = create_node( iv_parent_node     = io_cds_view_node->mv_node_key
                                                if_folder          = abap_true
    ...
    create_node( iv_parent_node     = lo_cds_properties_node->mv_node_key
                 iv_image           = zif_dbbr_c_icon=>user_menu
                 iv_hier1_item_text = |{ 'Responsible'(018) }|
                 is_hier2_item      = VALUE #( text  = ls_tadio_info-created_by
                                               style = zif_uitb_c_ctm_style=>inverted_blue )
                 ir_user_data       = NEW ty_s_user_data( node_type = c_node_type-cds_owner_prop
                                                          owner     = ls_tadio_info-created_by ) ).
    create_node( iv_parent_node     = lo_cds_properties_node->mv_node_key
                 iv_image           = zif_dbbr_c_icon=>date
                 iv_hier1_item_text = |{ 'Created On'(033) }|
                 is_hier2_item      = VALUE #( text  = |{ ls_tadio_info-created_date DATE = USER }|
                                               style = zif_uitb_c_ctm_style=>inverted_blue ) ).
    create_node( iv_parent_node     = lo_cds_properties_node->mv_node_key
                 iv_image           = zif_dbbr_c_icon=>package
                 iv_hier1_item_text = |{ 'Package'(001) }|
                 is_hier2_item      = VALUE #( text  = ls_tadio_info-devclass
                                               style = zif_uitb_c_ctm_style=>inverted_blue )
                 ir_user_data       = NEW ty_s_user_data( node_type = c_node_type-cds_package_prop
    ...
    IF lines( lt_api_states ) > 1.
      DATA(lo_cds_api_states_node) = create_node( iv_parent_node     = lo_cds_properties_node->mv_node_key
                                                  if_folder          = abap_true
    ...
    LOOP AT lt_api_states ASSIGNING FIELD-SYMBOL(<lv_api_state>).
      ...
      DATA(lv_icon) = COND tv_image( WHEN lf_not_released = abap_true
                                     THEN zif_dbbr_c_icon=>incomplete
                                     ELSE zif_dbbr_c_icon=>checked ).

      create_node( iv_parent_node     = lo_api_states_parent_node->mv_node_key
                   iv_image           = lv_icon
    ...
    IF lt_base_tables IS NOT INITIAL.
      DATA(lo_cds_select_node) = create_node( iv_parent_node     = io_cds_view_node->mv_node_key
                                              if_folder          = abap_true
      ...
      LOOP AT lt_base_tables ASSIGNING FIELD-SYMBOL(<ls_base_table>).
        lv_node_type = COND #(
          WHEN <ls_base_table>-table_kind = zif_sat_c_entity_type=>table
           AND <ls_base_table>-is_db_view = abap_true                       THEN c_node_type-view
          WHEN <ls_base_table>-table_kind = zif_sat_c_entity_type=>table
           AND <ls_base_table>-is_db_view = abap_false                      THEN c_node_type-dbtable
        ...
        DATA(lo_cds_base_table_node) = create_node(
            ...
            is_hier2_item      = VALUE #( text  = <ls_base_table>-description
                                          style = zif_uitb_c_ctm_style=>inverted_gray )
            ir_user_data       = NEW ty_s_user_data( entity_id     = <ls_base_table>-entityname
                                                     entity_id_raw = <ls_base_table>-entityname_raw
                                                     node_type     = lv_node_type ) ).

        IF lv_node_type = c_node_type-dbtable.
          create_db_table_subnodes( io_db_tab_view_node = lo_cds_base_table_node
                                    is_entity           = VALUE #( entity_id     = <ls_base_table>-entityname
                                                                   entity_id_raw = <ls_base_table>-entityname_raw
    ...
    IF lt_assoc IS NOT INITIAL.
      DATA(lo_cds_assoc_node) = create_node( if_folder          = abap_true
      ...
      LOOP AT lt_assoc ASSIGNING FIELD-SYMBOL(<ls_assoc>).
        lv_node_type = SWITCH #( <ls_assoc>-kind
                                 ...
                                 THEN c_node_type-dbtable
                                 ELSE c_node_type-cds_view ).
        lv_node_image = node_image_for_node_type( lv_node_type ).

        create_node( if_folder          = abap_true
                     iv_parent_node     = lo_cds_assoc_node->mv_node_key
                     if_expander        = abap_true
                     iv_image           = lv_node_image
                     iv_hier1_item_text = |{ <ls_assoc>-raw_name }|
                     is_hier2_item      = VALUE #( text  = |({ <ls_assoc>-ref_cds_view_raw })|
                                                   style = zif_uitb_c_ctm_style=>inverted_blue )
                     ir_user_data       = NEW ty_s_user_data( entity_id     = <ls_assoc>-ref_cds_view
        ...
        IF <ls_assoc>-kind = zif_sat_c_cds_assoc_type=>table.
          IF lv_node_type = c_node_type-dbtable.
            create_db_table_subnodes( io_db_tab_view_node = lo_cds_base_table_node
                                      is_entity           = VALUE #( entity_id     = <ls_assoc>-ref_cds_view
                                                                     entity_id_raw = <ls_assoc>-ref_cds_view_raw
                                                                     entity_type   = zif_sat_c_entity_type=>table ) ).
          ENDIF.
        ENDIF.
  ...
  METHOD create_tree.
    ...
    zcl_uitb_gui_helper=>create_control_toolbar( EXPORTING io_parent  = mo_splitter->get_container( 2 )
                                                           it_button  = VALUE #(
    ...
    mo_toolbar->set_button_state( fcode   = c_functions-next_history
                                  enabled = abap_false ).
    mo_toolbar->set_button_state( fcode   = c_functions-previous_history
                                  enabled = abap_false ).

    mo_toolbar->set_static_ctxmenu( EXPORTING  fcode   = c_functions-search_settings_menu
                                               ctxmenu = mo_settings_menu
                                    EXCEPTIONS OTHERS  = 1 ).
    mo_toolbar->set_static_ctxmenu( EXPORTING  fcode   = c_functions-favorite_dropdown
                                               ctxmenu = mo_favorite_dd_menu
                                    EXCEPTIONS OTHERS  = 1 ).
    SET HANDLER on_toolbar_button FOR mo_toolbar.

    mo_tree = NEW zcl_uitb_column_tree_model( ir_parent           = lo_container
                                              if_auto_node_key    = abap_true
                                              is_hierarchy_header = VALUE #( heading = 'Object Name'(010) )
    ...
    SET HANDLER on_node_enter_key FOR lo_events.
  ...
  METHOD expand_db_table.
    ...
    create_db_table_subnodes( io_db_tab_view_node = mo_tree->get_nodes( )->get_node( iv_node_key )
                              is_entity           = VALUE #( ) ).
  ENDMETHOD.
  ...
  METHOD expand_dbtab_view_properties.
    ...
    SELECT SINGLE * FROM zsat_i_databaseentity
  ...
  METHOD expand_foreign_key_tables.
    ...
    IF lt_foreign_key_tables IS INITIAL.
      RETURN.
    ENDIF.

    create_multiple_db_tab_tree( it_table_definition = lt_foreign_key_tables
  ...
  METHOD expand_cds_view_node.
    ...
    TRY.
        create_single_cds_view_tree( io_cds_view = zcl_sat_cds_view_factory=>read_cds_view( iv_cds_view )
  ...
  METHOD expand_package_dbtabs_node.
    zcl_dbbr_screen_helper=>show_progress( iv_text     = |{ 'Loading DB Tables of Package'(023) } { iv_package }|
                                           iv_progress = 1 ).

    DATA(lt_dbtabs) = zcl_sat_ddic_repo_access=>find_database_tab_view( iv_package = iv_package
                                                                        if_all     = abap_true
                                                                        iv_type    = zif_sat_c_entity_type=>table ).

    create_multiple_db_tab_tree( it_table_definition = lt_dbtabs
                                 io_parent_node      = mo_tree->get_nodes( )->get_node( iv_node_key ) ).
  ...
  METHOD expand_package_ddls_node.
    zcl_dbbr_screen_helper=>show_progress( iv_text     = |{ 'Loading DDLS of Package'(022) } { iv_package }|
                                           iv_progress = 1 ).
    DATA(lt_header_in_package) = zcl_sat_cds_view_factory=>find_cds_views( iv_package  = iv_package
                                                                           iv_max_rows = 0 ).

    create_multiple_cds_view_tree( it_cds_view_header = lt_header_in_package
                                   io_parent_node     = mo_tree->get_nodes( )->get_node( iv_node_key ) ).
  ...
  METHOD expand_package_node.
    cl_package=>load_package( EXPORTING  i_package_name = iv_package
                              IMPORTING  e_package      = DATA(lo_package)
                              EXCEPTIONS OTHERS         = 1 ).
    IF lo_package IS BOUND.
      create_single_package_tree( io_package = lo_package
                                  io_node    = mo_tree->get_nodes( )->get_node( iv_node_key ) ).
    ENDIF.
  ENDMETHOD.

  METHOD expand_package_views_node.
    zcl_dbbr_screen_helper=>show_progress( iv_text     = |{ 'Loading DB Views of Package'(024) } { iv_package }|
                                           iv_progress = 1 ).
    DATA(lt_views) = zcl_sat_ddic_repo_access=>find_database_tab_view( iv_package = iv_package
                                                                       if_all     = abap_true
                                                                       iv_type    = zif_sat_c_entity_type=>view ).

    create_multiple_db_tab_tree( it_table_definition = lt_views
                                 io_parent_node      = mo_tree->get_nodes( )->get_node( iv_node_key ) ).
  ...
  METHOD expand_query_node.
    ...
    DATA(ls_query) = mo_query_f->get_query( iv_query_name      = iv_query
                                            if_load_completely = abap_false ).

    " .. Create properties node of query
    " .. Create "Properties" Sub node
    DATA(lo_query_props_node) = create_node( if_folder          = abap_true
    ...
    create_node( iv_parent_node     = lo_query_props_node->mv_node_key
                 iv_image           = zif_dbbr_c_icon=>user_menu
                 iv_hier1_item_text = |{ TEXT-018 }|
                 is_hier2_item      = VALUE #( text  = |{ ls_query-created_by }|
                                               style = zif_uitb_c_ctm_style=>inverted_blue )
                 ir_user_data       = NEW ty_s_user_data( entity_id = ls_query-query_name
                                                          node_type = c_node_type-query_owner_prop
                                                          owner     = ls_query-created_by ) ).
    create_node( iv_parent_node     = lo_query_props_node->mv_node_key
                 iv_image           = zif_dbbr_c_icon=>date
                 iv_hier1_item_text = |{ TEXT-033 }|
                 is_hier2_item      = VALUE #( text  = |{ ls_query-created_date DATE = USER }|
                                               style = zif_uitb_c_ctm_style=>inverted_blue ) ).
    create_node( iv_parent_node     = lo_query_props_node->mv_node_key
    ...
    IF lt_base_tables IS NOT INITIAL.
      ...
      DATA(lo_query_entities_node) = create_node( if_folder          = abap_true
      ...
      LOOP AT lt_base_tables ASSIGNING FIELD-SYMBOL(<ls_base_table>).
        ...
        DATA(lo_base_table_node) = create_node(
                                       ...
                                       ir_user_data       = NEW ty_s_user_data( entity_id = <ls_base_table>-entity_id
                                                                                node_type = lv_node_type ) ).

        IF lv_node_type <> c_node_type-cds_view.
          create_db_table_subnodes( io_db_tab_view_node = lo_base_table_node
  ...
  METHOD expand_tech_settings_node.
    SELECT SINGLE * FROM zdbbr_i_dbtabletechsettings
    ...
    create_node( iv_parent_node     = iv_node_key
                 ...
                 is_hier2_item      = VALUE #( text  = |'{ ls_tech_settings-deliveryclass }'|
                                               style = zif_uitb_c_ctm_style=>inverted_blue )
                 is_hier3_item      = COND #(
                   WHEN ls_tech_settings-deliveryclasstext IS NOT INITIAL
                   THEN VALUE #( text  = |{ ls_tech_settings-deliveryclasstext }|
                                 style = zif_uitb_c_ctm_style=>inverted_gray ) ) ).
    create_node( iv_parent_node     = iv_node_key
                 iv_hier1_item_text = |{ 'Size Category' }|
                 is_hier2_item      = VALUE #( text  = |'{ ls_tech_settings-sizecategory }'|
                                               style = zif_uitb_c_ctm_style=>inverted_blue )
                 is_hier3_item      = COND #(
                   WHEN ls_tech_settings-sizecategorytext IS NOT INITIAL
                   THEN VALUE #( text  = |{ ls_tech_settings-sizecategorytext }|
                                 style = zif_uitb_c_ctm_style=>inverted_gray ) ) ).
    create_node( iv_parent_node     = iv_node_key
                 iv_hier1_item_text = |{ 'Data Class' }|
                 is_hier2_item      = VALUE #( text  = |'{ ls_tech_settings-dataclass }'|
                                               style = zif_uitb_c_ctm_style=>inverted_blue )
                 is_hier3_item      = COND #(
                   WHEN ls_tech_settings-dataclasstext IS NOT INITIAL
                   THEN VALUE #( text  = |{ ls_tech_settings-dataclasstext }|
                                 style = zif_uitb_c_ctm_style=>inverted_gray ) ) ).
    create_node( iv_parent_node     = iv_node_key
                 iv_hier1_item_text = |{ 'Buffering' }|
                 is_hier2_item      = VALUE #( text  = |'{ ls_tech_settings-bufferingindicator }'|
                                               style = zif_uitb_c_ctm_style=>inverted_blue )
                 is_hier3_item      = COND #(
                   WHEN ls_tech_settings-bufferingindicatortext IS NOT INITIAL
                   THEN VALUE #( text  = |{ ls_tech_settings-bufferingindicatortext }|
                                 style = zif_uitb_c_ctm_style=>inverted_gray ) ) ).
  ...
  METHOD export_queries.
    ...
    DATA lt_query_name_range TYPE RANGE OF zsat_query_name.
    ...
    LOOP AT lt_selected_nodes ASSIGNING FIELD-SYMBOL(<lr_node>).
      ...
      IF lr_user_data->node_type = c_node_type-query.
        lt_query_name_range = VALUE #( BASE lt_query_name_range
                                       ( sign = 'I' option = 'EQ' low = lr_user_data->entity_id ) ).
      ENDIF.
    ENDLOOP.
    ...
    SELECT query_id FROM zdbbr_queryh
      WHERE query_name IN @lt_query_name_range
      INTO CORRESPONDING FIELDS OF TABLE @lt_query_to_export.

    NEW zcl_dbbr_query_exporter( it_query_info = lt_query_to_export
      )->export_data( ).
  ENDMETHOD.
  ...
  METHOD fill_favorite_dd_menu.
    ...
    mo_favorite_dd_menu->add_function( fcode = c_functions-add_favorite
                                       text  = |{ 'Add'(027) }| ).
    mo_favorite_dd_menu->add_function( fcode = c_functions-edit_favorites
                                       text  = |{ 'Edit...'(028) }| ).
    mo_favorite_dd_menu->add_separator( ).
    mo_favorite_dd_menu->add_function( fcode = c_functions-my_db_tables_search
                                       text  = |{ 'My Database Tables' }| ).
    mo_favorite_dd_menu->add_function( fcode = c_functions-my_db_views_search
                                       text  = |{ 'My Database Views' }| ).
    mo_favorite_dd_menu->add_function( fcode = c_functions-my_cds_views_search
                                       text  = |{ 'My CDS Views' }| ).
    mo_favorite_dd_menu->add_function( fcode = c_functions-my_queries_search
                                       text  = |{ 'My Queries' }| ).
    mo_favorite_dd_menu->add_separator( ).
    ...
    LOOP AT lt_favorites ASSIGNING FIELD-SYMBOL(<ls_fav>)
      ...
      LOOP AT GROUP <lv_type> ASSIGNING FIELD-SYMBOL(<ls_favorite>).
        lv_fav_func_counter = lv_fav_func_counter + 1.
        ...
        lo_submenu->add_function( fcode = lv_favorite_func
                                  text  = <ls_favorite>-favorite_name ).
      ENDLOOP.

      mo_favorite_dd_menu->add_submenu( menu = lo_submenu
  ...
  METHOD on_display_object_list.
    ...
    zcl_dbbr_screen_helper=>show_progress( iv_text     = |{ 'Loading Object List...'(016) }|
                                           iv_progress = 1 ).
    ...
    TRY.
        IF    mo_search_query           IS INITIAL
           OR mo_search_query->mv_query <> ev_entity_id. " OR
*           mo_search_query->mv_type <> ev_entity_type.

          mo_search_query = parse_query( iv_query        = |{ ev_entity_id }|
                                         iv_browser_mode = mv_current_search_type ).
          IF NOT mo_search_query->has_search_terms( ).
            RETURN.
          ENDIF.
  ...
  METHOD on_expand_no_children.
    ...
    zcl_dbbr_screen_helper=>show_progress( iv_text     = |{ 'Loading Tree Nodes...'(015) }|
                                           iv_progress = 1 ).

    CASE lr_user_data->node_type.

      WHEN c_node_type-cds_view.
        expand_cds_view_node( iv_node_key = ev_node_key
                              iv_cds_view = lr_user_data->entity_id ).

      WHEN c_node_type-package.
        expand_package_node( iv_package  = lr_user_data->entity_id
                             iv_node_key = ev_node_key ).

      WHEN c_node_type-pak_dtab_folder.
        expand_package_dbtabs_node( iv_package  = lr_user_data->entity_id
                                    iv_node_key = ev_node_key ).

      WHEN c_node_type-pak_ddl_folder.
        expand_package_ddls_node( iv_package  = lr_user_data->entity_id
                                  iv_node_key = ev_node_key ).

      WHEN c_node_type-pak_view_folder.
        expand_package_views_node( iv_package  = lr_user_data->entity_id
                                   iv_node_key = ev_node_key ).

      WHEN c_node_type-dbtable_foreign_key.
        expand_foreign_key_tables( iv_tabname  = lr_user_data->entity_id
                                   iv_node_key = ev_node_key ).

      WHEN c_node_type-dbtable_tech_settings.
        expand_tech_settings_node( iv_tabname  = lr_user_data->entity_id
                                   iv_node_key = ev_node_key ).

      WHEN c_node_type-dbtable_properties OR
           c_node_type-view_properties.
        expand_dbtab_view_properties( iv_tabname   = lr_user_data->entity_id
                                      iv_node_type = lr_user_data->node_type
                                      iv_node_key  = ev_node_key ).

      WHEN c_node_type-view_tables.
        expand_view_node( iv_view     = lr_user_data->entity_id
                          iv_node_key = ev_node_key ).

      WHEN c_node_type-query.
        expand_query_node( iv_query    = lr_user_data->entity_id
                           iv_node_key = ev_node_key ).
    ENDCASE.
  ENDMETHOD.
  ...
  METHOD on_external_object_search_req.
    TRY.
        IF    mo_search_query           IS INITIAL
           OR mo_search_query->mv_query <> ev_search_query. " OR
*           mo_search_query->mv_type <> ev_object_type.

          mv_current_search_type = ev_object_type.

          mo_search_query = parse_query( iv_query        = |{ ev_search_query }|
                                         iv_browser_mode = mv_current_search_type ).
          add_history_entry( ).
        ENDIF.
      ...
      CASE <ls_user_data>-node_type.
        ...
        WHEN c_node_type-cds_view OR
          ...
          IF <ls_user_data>-node_type <> c_node_type-query.
            er_menu->add_function( fcode = c_functions-open_with_adt
                                   text  = |{ 'Open with ADT'(029) }| ).
          ENDIF.

          er_menu->add_function( fcode = c_functions-open_in_new_window
                                 text  = |{ 'Open in new Window'(030) }| ).
          er_menu->add_separator( ).
          er_menu->add_function( fcode = c_functions-exec_with_dbbrs
                                 text  = |{ 'Show Content'(031) }| ).
          er_menu->add_function( fcode = c_functions-exec_with_dbbrs_new_window
                                 text  = |{ 'Show Content (New Task)'(032) }| ).
          IF <ls_user_data>-node_type = c_node_type-cds_view.
            er_menu->add_separator( ).
            er_menu->add_function( fcode = c_functions-show_ddl_source
                                   text  = |{ 'Show DDL Source Code'(034) }| ).
            er_menu->add_function( fcode = c_functions-analyze_dependencies
                                   text  = |{ 'Open with Dependency Analyzer'(035) }| ).
          ENDIF.

          IF <ls_user_data>-node_type <> c_node_type-query.
            er_menu->add_separator( ).
            er_menu->add_function( fcode = c_functions-used_in_select_from
                                   text  = |{ 'Show uses in FROM of CDS Views'(040) }| ).
            er_menu->add_function( fcode = c_functions-used_as_assoc
                                   text  = |{ 'Show uses as Associations of CDS Views'(041) }| ).
          ENDIF.

        WHEN OTHERS.
          IF is_package_sub_node( <ls_user_data>-node_type ).
            er_menu->add_function( fcode = c_functions-add_package_to_query
                                   text  = |{ 'Add package to current Query'(042) }| ).
            er_menu->add_function( fcode = c_functions-add_root_package_to_query
        ...
        TRY.
            zcl_sat_adt_util=>jump_adt(
                iv_obj_name = SWITCH #( <ls_user_data>-node_type
                                        WHEN c_node_type-cds_view
                                        THEN zcl_sat_cds_view_factory=>get_ddl_for_entity_name( <ls_user_data>-entity_id )
                                        ELSE <ls_user_data>-entity_id )
                iv_obj_type = SWITCH #(
                <ls_user_data>-node_type
                WHEN c_node_type-cds_view THEN 'DDLS'
                WHEN c_node_type-dbtable  THEN 'TABD'
                WHEN c_node_type-view     THEN 'VIEW' ) ).
          CATCH zcx_sat_adt_error INTO DATA(lx_adt_error). " TODO: variable is assigned but never used (ABAP cleaner)
          CATCH zcx_sat_data_read_error INTO DATA(lx_data_read_error). " TODO: variable is assigned but never used (ABAP cleaner)
        ENDTRY.

      WHEN c_functions-open_in_new_window.
        CALL FUNCTION 'ZDBBR_SHOW_SELSCREEN' STARTING NEW TASK 'ZDBBR_OBJ_BRS_OPEN_JUMP'
          EXPORTING iv_entity_id       = <ls_user_data>-entity_id
...
*        ENDIF.
      ...
      WHEN c_functions-show_ddl_source.
        ...
        TRY.
            ...
            zcl_uitb_abap_code_viewer=>show_code( iv_title = |DDL Source { <ls_user_data>-entity_id_raw }|
                                                  iv_code  = lv_source
                                                  iv_theme = mv_theme ).
      ...
      WHEN c_functions-used_as_assoc.
        on_external_object_search_req( ev_object_type  = zif_dbbr_c_object_browser_mode=>cds_view
      ...
      WHEN c_functions-add_root_package_to_query.
        cl_pak_package_queries=>get_root_package( EXPORTING  im_package      = <ls_user_data>-devclass
        ...
        IF sy-subrc <> 0.
          ...
          RETURN.
        ENDIF.
        on_external_object_search_req( ev_object_type  = |{ mo_search_type_select->value }|
  ...
  METHOD on_node_double_click.
    ...
    IF    <ls_user_data>-node_type = c_node_type-cds_view
       OR <ls_user_data>-node_type = c_node_type-query
       OR <ls_user_data>-node_type = c_node_type-dbtable
       OR <ls_user_data>-node_type = c_node_type-view.
      ...
      zcl_dbbr_selscr_nav_events=>raise_entity_chosen(
          ...
          iv_entity_type = SWITCH #(
            ...
            WHEN c_node_type-dbtable  THEN zif_sat_c_entity_type=>table
            WHEN c_node_type-view     THEN zif_sat_c_entity_type=>table ) ).
    ELSEIF    <ls_user_data>-node_type = c_node_type-cds_tables
           OR <ls_user_data>-node_type = c_node_type-cds_assocs
           OR <ls_user_data>-node_type = c_node_type-cds_properties.
      mo_tree->get_nodes( )->toggle_node( ev_node_key ).

    " ... Trigger new owner:/package: queries depending on the entity
    ELSEIF    <ls_user_data>-node_type = c_node_type-dbtable_owner_prop
           OR <ls_user_data>-node_type = c_node_type-dbtable_package_prop
           OR <ls_user_data>-node_type = c_node_type-query_owner_prop
           OR <ls_user_data>-node_type = c_node_type-view_package_prop
           OR <ls_user_data>-node_type = c_node_type-view_owner_prop
           OR <ls_user_data>-node_type = c_node_type-cds_owner_prop
           OR <ls_user_data>-node_type = c_node_type-cds_package_prop.
  ...
  METHOD on_perform_search.
    ...
    IF    mo_search_query           IS INITIAL
       OR mo_search_query->mv_query <> mo_search_input->value. " OR
*       mo_search_query->mv_type <> mo_search_type_select->value.

      TRY.
          mo_search_query = parse_query( iv_query        = |{ mo_search_input->value }|
                                         iv_browser_mode = mv_current_search_type ).
          add_history_entry( ).
  ...
  METHOD on_search_input_enter.
    ...
    IF    mo_search_query           IS INITIAL
       OR mo_search_query->mv_query <> mo_search_input->value
       OR mo_search_query->mv_type  <> lv_current_search_type.
  ...
  METHOD on_toolbar_button.
    CASE fcode.
      ...
      WHEN c_functions-collapse_all.
        DATA(lt_selected_nodes) = mo_tree->get_selections( )->get_selected_nodes( ).
        LOOP AT lt_selected_nodes ASSIGNING FIELD-SYMBOL(<lo_node>).
          mo_tree->get_nodes( )->collapse_node( iv_node_key         = <lo_node>->mv_node_key
      ...
      WHEN c_functions-my_cds_views_search OR
        ...
        trigger_my_objects_search( iv_fcode = fcode ).
      ...
      WHEN OTHERS.
        IF fcode CP 'HIST*'.
          go_to_historic_entry( iv_function = fcode ).
        ELSEIF fcode CP 'FAV:*'.
          trigger_query_from_favorite( iv_function = fcode ).
        ENDIF.
    ENDCASE.
  ENDMETHOD.
  ...
  METHOD show_superordinate_tree.
    ...
    IF    lr_user_data->node_type = c_node_type-cds_view
    ...
    zcl_dbbr_screen_helper=>show_progress( iv_progress = 1
                                           iv_text     = |{ 'Loading parent package...'(025) }| ).

    cl_package=>load_package( EXPORTING i_package_name = lv_package
                              IMPORTING e_package      = DATA(lo_package) ).
    ...
    TRY.
        mo_search_query = parse_query( iv_query        = |{ lv_package }|
  ...
  METHOD add_history_entry.
    ...
    INSERT VALUE ty_s_history( id         = |HIST{ lines( mt_history_stack ) + 1 }|
  ...
  METHOD trigger_new_search.
    ...
    DATA lv_found_lines TYPE sy-tabix.
    ...
    TRY.
        CASE mv_current_search_type.
          ...
          WHEN zif_dbbr_c_object_browser_mode=>cds_view.
            ...
            show_results_message( iv_result_count = lv_found_lines
                                  iv_max_count    = mo_search_query->mv_max_rows ).
            IF lv_found_lines = 0.
              clear_tree( ).
            ELSEIF lv_found_lines = 1.
              create_single_cds_view_tree(
                  io_cds_view = zcl_sat_cds_view_factory=>read_cds_view( |{ lt_search_result[ 1 ]-entity_id }| ) ).
            ELSEIF lv_found_lines > 1.
              create_multiple_cds_view_tree( it_cds_view_header = lt_search_result ).
            ENDIF.
  ...
  METHOD update_toolbar.
    " TODO: parameter IF_MULTIPLE_TREE is never used (ABAP cleaner)
    ...
    mo_toolbar->set_button_state( EXPORTING  enabled = lf_to_parent_enabled
                                             fcode   = c_functions-to_parent
                                  EXCEPTIONS OTHERS  = 1 ).

    mo_toolbar->set_button_visible( EXPORTING  visible = lf_import_export_visible
  ...
  METHOD update_history_buttons.
    ...
    DATA lv_function_text TYPE gui_text.
    DATA lv_function_string TYPE char256.
    DATA lf_next TYPE abap_bool.
    ...
    IF lf_next = abap_true.
      ...
      LOOP AT mt_history_stack ASSIGNING <ls_history> TO lv_current_entry - 1.
        set_function_text.
        lo_next_menu->add_function( fcode             = <ls_history>-id
                                    text              = lv_function_text
                                    insert_at_the_top = abap_true ).
      ENDLOOP.
      IF sy-subrc = 0.
        mo_toolbar->set_static_ctxmenu( fcode   = c_functions-next_history
                                        ctxmenu = lo_next_menu ).
      ENDIF.
    ENDIF.
    ...
    IF lf_previous = abap_true.
      ...
      LOOP AT mt_history_stack ASSIGNING <ls_history> FROM lv_current_entry + 1.
        set_function_text.
        lo_previous_menu->add_function( fcode = <ls_history>-id
                                        text  = lv_function_text ).
      ENDLOOP.
      IF sy-subrc = 0.
        mo_toolbar->set_static_ctxmenu( fcode   = c_functions-previous_history
                                        ctxmenu = lo_previous_menu ).
      ENDIF.
    ENDIF.
  ...
  METHOD go_to_previous_historic_entry.
    DATA(lv_current_entry) = line_index( mt_history_stack[ is_current = abap_true ] ).
    IF lv_current_entry = 0.
      RETURN.
    ENDIF.

    lv_current_entry = lv_current_entry + 1.
  ...
  METHOD edit_favorites.
    NEW zcl_dbbr_ob_fav_manager( )->show( iv_top    = 5
                                          iv_left   = 10
                                          iv_width  = 120
                                          iv_height = 15 ).
    fill_favorite_dd_menu( ).
  ...
  METHOD add_favorite.
    ...
    TRY.
        parse_query( iv_query        = |{ mo_search_input->value }|
                     iv_browser_mode = mv_current_search_type ).
      CATCH zcx_sat_object_search INTO DATA(lx_parse_error).
        MESSAGE lx_parse_error TYPE 'S' DISPLAY LIKE 'E'.
        RETURN.
    ...
    DATA(lo_popup) = zcl_uitb_pgv_factory=>create_single_field_popup(
                         ...
                         is_field = VALUE #( tabname   = 'ZDBBR_OBJBRSFAV'
    ...
    IF NOT lo_popup->cancelled( ).
      ...
      IF zcl_dbbr_ob_fav_factory=>create_favorite( iv_query = |{ mo_search_input->value }|
  ...
  METHOD trigger_query_from_favorite.
    ...
    IF ls_map_entry IS INITIAL.
      RETURN.
    ENDIF.

    TRY.
        mo_search_query = parse_query( iv_query        = ls_map_entry-query
  ...
  METHOD parse_query.
    ...
    ro_query = lo_search_engine->parse_query( iv_search_query = iv_query
    ...
    IF lv_search_type = zif_sat_c_object_search=>c_search_type-ddic_view.
      ...
      ro_query->set_option(
          VALUE #( option      = zif_sat_c_object_search=>c_general_search_params-type
                   value_range = VALUE #(
                       ( sign = 'I' option = 'EQ' low = zif_sat_c_os_view_options=>c_view_class-int-database ) ) ) ).
    ENDIF.
  ENDMETHOD.
  ...
  METHOD update_search_settings_menu.
    ...
    mo_settings_menu->add_function( fcode   = c_functions-use_and_instead_of_or
  ...
  METHOD map_to_dbbr_query_type.
    rv_browser_type = SWITCH #( iv_sat_type
                                WHEN zif_sat_c_object_search=>c_search_type-cds_view THEN
                                  zif_dbbr_c_object_browser_mode=>cds_view
                                WHEN zif_sat_c_object_search=>c_search_type-db_tab THEN
                                  zif_dbbr_c_object_browser_mode=>database_table
                                WHEN zif_sat_c_object_search=>c_search_type-ddic_view THEN
                                  zif_dbbr_c_object_browser_mode=>database_view
                                WHEN zif_dbbr_c_object_browser=>c_search_type-query THEN
                                  zif_dbbr_c_object_browser_mode=>query
                                WHEN zif_dbbr_c_object_browser=>c_search_type-package THEN
                                  zif_dbbr_c_object_browser_mode=>package ).
  ENDMETHOD.

  METHOD map_to_sat_query_type.
    rv_sat_type = SWITCH #( iv_browser_type
                            WHEN zif_dbbr_c_object_browser_mode=>cds_view THEN
                              zif_sat_c_object_search=>c_search_type-cds_view
                            WHEN zif_dbbr_c_object_browser_mode=>database_table THEN
                              zif_sat_c_object_search=>c_search_type-db_tab
                            WHEN zif_dbbr_c_object_browser_mode=>database_view THEN
                              zif_sat_c_object_search=>c_search_type-ddic_view
                            WHEN zif_dbbr_c_object_browser_mode=>query THEN
                              zif_dbbr_c_object_browser=>c_search_type-query
                            WHEN zif_dbbr_c_object_browser_mode=>package THEN
                              zif_dbbr_c_object_browser=>c_search_type-package ).
  ENDMETHOD.
ENDCLASS.

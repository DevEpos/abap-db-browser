"! <p class="shorttext synchronized">Util for Toolbars in DB Browser</p>
CLASS zcl_dbbr_toolbar_util DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.

  PUBLIC SECTION.
    "! <p class="shorttext synchronized">Toolbar button was pressed</p>
    CLASS-EVENTS toolbar_button_pressed
      EXPORTING
        VALUE(ev_function) TYPE ui_func.

    "! <p class="shorttext synchronized">Free selection screen entity toolbar</p>
    CLASS-METHODS free_selscreen_entity_tb.
    "! <p class="shorttext synchronized">Free selection screen table toolbar</p>
    CLASS-METHODS free_selscreen_table_tb.
    "! <p class="shorttext synchronized">Free main selection screen toolbar</p>
    CLASS-METHODS free_main_selscreen_tb.

    "! <p class="shorttext synchronized">Get Selection Screen entity toolbar</p>
    CLASS-METHODS get_selscreen_entity_tb
      RETURNING
        VALUE(rr_toolbar) TYPE REF TO cl_gui_toolbar.

    "! <p class="shorttext synchronized">Get selection Screen Table Toolbar</p>
    CLASS-METHODS get_selscreen_table_tb
      RETURNING
        VALUE(rr_toolbar) TYPE REF TO cl_gui_toolbar.

    "! <p class="shorttext synchronized">Get main toolbar of selection screen</p>
  ...
  PRIVATE SECTION.
    ...
    "! <p class="shorttext synchronized">Handler for TB function set</p>
...
CLASS zcl_dbbr_toolbar_util IMPLEMENTATION.
  ...
  METHOD get_selscreen_entity_tb.
    ...
    IF go_selscreen_entity_toolbar_c IS INITIAL.
      ...
      SET HANDLER on_tb_set_function_handler FOR go_selscreen_entity_toolbar.
    ENDIF.
  ...
  METHOD get_selscreen_main_tb.
    ...
    IF go_selcreen_main_toolbar_c IS INITIAL.
      go_selcreen_main_toolbar_c = NEW cl_gui_docking_container( side      = cl_gui_docking_container=>dock_at_top
                                                                 extension = 15
...
*      go_selcreen_main_toolbar_c = NEW cl_gui_custom_container(  container_name = 'SELSCREEN_TOOLBAR' ).
      ...
      SET HANDLER on_tb_set_function_handler FOR go_selcreen_main_toolbar.
    ENDIF.
  ...
  METHOD get_selscreen_table_tb.
    ...
    IF go_selscreen_table_toolbar_c IS INITIAL.
      ...
      SET HANDLER on_tb_set_function_handler FOR go_selscreen_table_toolbar.
    ENDIF.

  ...
  PUBLIC SECTION.
    ...
    CLASS-EVENTS display_object_list
      EXPORTING
        ...
        VALUE(ev_entity_type) TYPE zsat_entity_type.
    "! <p class="shorttext synchronized">Request next view in object navigator</p>
    CLASS-EVENTS goto_next_view_in_objnav.

    "! <p class="shorttext synchronized">Raise ENTITY_CHOSEN event</p>
    ...
    "! <p class="shorttext synchronized">Raise VARIANT_ENTRY_CHOSEN event</p>
    ...
    "! <p class="shorttext synchronized">Raise FAVTREE_EVENT event</p>
    CLASS-METHODS raise_favtree_event
      IMPORTING
        ir_handler TYPE REF TO zif_dbbr_favmenu_evt_handler.

    "! <p class="shorttext synchronized">Raise event DISPLAY_OBJECT_LIST</p>
    "!
    "! @parameter iv_entity_id   | <p class="shorttext synchronized"></p>
    "! @parameter iv_entity_type | <p class="shorttext synchronized"></p>
    CLASS-METHODS raise_display_object_list
      IMPORTING
        iv_entity_id   TYPE zsat_entity_id
        iv_entity_type TYPE zsat_entity_type.

    "! <p class="shorttext synchronized">Raise event OBJECT_SEARCH</p>
    "!
    "! @parameter iv_object_type  | <p class="shorttext synchronized"></p>
    "! @parameter iv_search_query | <p class="shorttext synchronized"></p>
    ...
    "! <p class="shorttext synchronized">Raise event REQUEST_OBJECT_SEARCH</p>
    "!
    "! @parameter iv_object_type      | <p class="shorttext synchronized"></p>
    "! @parameter iv_search_query     | <p class="shorttext synchronized"></p>
    "! @parameter if_close_on_success | <p class="shorttext synchronized"></p>
    ...
    "! <p class="shorttext synchronized">Raise event GOTO_NEXT_VIEW_IN_OBJNAV</p>
    "!
    CLASS-METHODS raise_goto_nxt_view_in_objnav.
    "! <p class="shorttext synchronized">Raise event CLOSE_OBJECT_SEARCH_MODAL</p>
    "!

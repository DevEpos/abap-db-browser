"! <p class="shorttext synchronized">Utility methods for Selection Controller</p>
CLASS zcl_dbbr_selection_util DEFINITION
  ...
  PUBLIC SECTION.
    ...
    ALIASES get_deactivated_functions FOR zif_dbbr_screen_util~get_deactivated_functions.
    ALIASES handle_pbo                FOR zif_dbbr_screen_util~handle_pbo.
    ALIASES handle_ui_function        FOR zif_dbbr_screen_util~handle_ui_function.
    ...
    "! <p class="shorttext synchronized">Selection did finish</p>
    EVENTS selection_finished
      EXPORTING
        VALUE(ef_first_select) TYPE abap_bool OPTIONAL
        VALUE(ef_reset_alv_table) TYPE abap_bool OPTIONAL.
    "! <p class="shorttext synchronized">No data was found</p>
    EVENTS no_data
      EXPORTING
        VALUE(ef_criteria_exist) TYPE abap_bool OPTIONAL.

    "! <p class="shorttext synchronized">Create typed utility for selection</p>
    ...
    "! <p class="shorttext synchronized">Builds simple alv title</p>
    ...
    "! <p class="shorttext synchronized">Executes the selection for the entity</p>
    METHODS execute_selection
      RAISING
        zcx_dbbr_application_exc.

    "! <p class="shorttext synchronized">Executes the given function</p>
    ...
    "! <p class="shorttext synchronized">Fills the dynamic document header on top of the alv output</p>
    METHODS fill_header
      CHANGING
        cr_dd_doc TYPE REF TO cl_dd_document.

    "! <p class="shorttext synchronized">Transform Criteria to ALV Filter</p>
    METHODS get_alv_filter_from_criteria
      RETURNING
        VALUE(rt_filter) TYPE lvc_t_filt.

    "! <p class="shorttext synchronized">Retrieve ALV Util instance</p>
    METHODS get_alv_util
      RETURNING
        VALUE(rr_alv_util) TYPE REF TO zcl_dbbr_output_alv_util.

    "! <p class="shorttext synchronized">Retrieves information about entity</p>
    METHODS get_entity_name
      ABSTRACT
      RETURNING
        VALUE(result) TYPE tabname.

    "! <p class="shorttext synchronized">Handle custom context menu request for alv</p>
    ...
    "! <p class="shorttext synchronized">Initialization of util</p>
    METHODS init
      ABSTRACT.

    "! <p class="shorttext synchronized">Checks if there is an active table join</p>
    METHODS is_join_active
      RETURNING
        VALUE(result) TYPE abap_bool.

    "! <p class="shorttext synchronized">Refresh the selection</p>
    METHODS refresh_selection
      IMPORTING
        if_reset_table_in_alv TYPE abap_bool OPTIONAL.

    "! <p class="shorttext synchronized">Sets the column texts for the given field catalog entry</p>
    ...
    "! <p class="shorttext synchronized">Update where condition from ALV Filter</p>
    ...
    "! <p class="shorttext synchronized">Unregisters any active event handlers</p>
  ...
  PROTECTED SECTION.
    ...
    DATA mt_group_tab_map TYPE HASHED TABLE OF ty_group_tab_map WITH UNIQUE KEY sp_group.
    DATA mf_count_lines TYPE abap_bool.
    "! <p class="shorttext synchronized">ID of an DB Browser entity</p>
    DATA mv_entity_id TYPE zsat_entity_id.
    "! <p class="shorttext synchronized">Type of Entity</p>
    ...
    "! <p class="shorttext synchronized">Field Catalog for List Viewer Control</p>
    ...
    "! <p class="shorttext synchronized">List of FROM clauses</p>
    DATA mt_from TYPE string_table.
    "! <p class="shorttext synchronized">List of SELECT clauses</p>
    DATA mt_select TYPE string_table.
    "! <p class="shorttext synchronized">List of WHERE clauses</p>
    DATA mt_where TYPE string_table.
    "! <p class="shorttext synchronized">List of GROUP BY clauses</p>
    DATA mt_group_by TYPE string_table.
    "! <p class="shorttext synchronized">List of ORDER BY clauses</p>
    DATA mt_order_by TYPE string_table.
    "! <p class="shorttext synchronized">List of HAVING clauses</p>
    ...
    DATA mt_virtual_join_table_range TYPE RANGE OF tabname.
    DATA mf_case_insensitive_search TYPE abap_bool.
    "! <p class="shorttext synchronized">List of Strings</p>
    DATA mt_nav_breadcrumbs TYPE string_table.
    DATA mv_navigation_count TYPE i.
    "! <p class="shorttext synchronized">Dynamic Documents: Document</p>
    ...
    "! <p class="shorttext synchronized">ALV tree control: Index list</p>
    DATA mt_selected_rows TYPE lvc_t_indx.
    "! <p class="shorttext synchronized">Definition of a Join</p>
    DATA ms_join_def TYPE zdbbr_join_def.
    DATA mt_current_live_filter TYPE lvc_t_filt.
    "! <p class="shorttext synchronized">Abstract ALV Filter for Output Grid</p>
    ...
    "! <p class="shorttext synchronized">Adds column for hiding rows</p>
    METHODS add_hide_flag_column.
    "! <p class="shorttext synchronized">Adds Column for a line index / group count</p>
    METHODS add_line_index_column.
    "! <p class="shorttext synchronized">Build full field names for selection and output (i.e. alias)</p>
    METHODS build_full_fieldnames.

    "! <p class="shorttext synchronized">Clears all aggregation info from fields</p>
    METHODS clear_aggregation_fields
      CHANGING
        ct_selection_fields TYPE zdbbr_selfield_itab.

    "! <p class="shorttext synchronized">Only count the lines for the given filter criteria</p>
    METHODS count_lines.
    "! <p class="shorttext synchronized">Count lines without aggregation active</p>
    METHODS count_lines_simple.
    "! <p class="shorttext synchronized">Count lines with active aggregation fields</p>
    METHODS count_lines_with_aggregation.
    "! <p class="shorttext synchronized">Creates default SQL where clause from criteria</p>
    METHODS create_default_where_clause.

    "! <p class="shorttext synchronized">Creates the dynamic internal table to hold the selected data</p>
    METHODS create_dynamic_table
      IMPORTING
        if_cache_existing_data TYPE abap_bool OPTIONAL.

    "! <p class="shorttext synchronized">Creates the field catalog for the output</p>
    METHODS create_field_catalog.
    "! <p class="shorttext synchronized">Creates FOR ALL ENTRIES where clause</p>
    METHODS create_for_all_where_clause.
    "! <p class="shorttext synchronized">Creates the from clause for the select</p>
    METHODS create_from_clause.
    "! <p class="shorttext synchronized">Creates the group by clause for the select</p>
    METHODS create_group_by_clause.
    "! <p class="shorttext synchronized">Creates the order by clause for the select</p>
    METHODS create_order_by_clause.
    "! <p class="shorttext synchronized">Creates the projection fields for the select</p>
    METHODS create_select_clause.

    "! <p class="shorttext synchronized">Creates field catalog entry for a text field</p>
    ...
    "! <p class="shorttext synchronized">Creates the where condition</p>
    METHODS create_where_clause.
    "! <p class="shorttext synchronized">Determines if there is an aggregation field in the selection</p>
    METHODS determine_aggregation_state.

    "! <p class="shorttext synchronized">Determines if the field should be displayed as a checkbox</p>
    ...
    "! <p class="shorttext synchronized">Determines if a group by fields exists in the selection</p>
    METHODS determine_group_by_state.
    "! <p class="shorttext synchronized">Exectue formulas for selected lines</p>
    METHODS execute_formula_for_lines.

    "! <p class="shorttext synchronized">Fills the quantity/currency field for another field</p>
    ...
    "! <p class="shorttext synchronized">Retrieves the short texts for the given table fields</p>
    ...
    "! <p class="shorttext synchronized">Retrieves SQL of current selection</p>
    "!
    ...
    "! <p class="shorttext synchronized">Handles a possible Jump Field</p>
    ...
    "! <p class="shorttext synchronized">Handles reduced memory setting</p>
    METHODS handle_reduced_memory.

    "! <p class="shorttext synchronized">Initialize the navigation breadcrumbs</p>
    METHODS init_navigation_breadcrumbs
      IMPORTING
        ir_container TYPE REF TO cl_gui_container.

    "! <p class="shorttext synchronized">Functional check if empty result should be ignored</p>
    ...
    "! <p class="shorttext synchronized">Returns 'X' if saving as F4 is allowed</p>
    METHODS is_f4_saving_allowed
      RETURNING
        VALUE(rf_allowed) TYPE abap_bool.

    "! <p class="shorttext synchronized">Opens current query in SQL console</p>
    "!
    METHODS open_in_sql_console.
    "! <p class="shorttext synchronized">Raise NO_DATA event</p>
    METHODS raise_no_data_event.
    "! <p class="shorttext synchronized">Read information about all entities in the selection</p>
    METHODS read_entity_infos.

    "! <p class="shorttext synchronized">Select the actual data</p>
    METHODS select_data
      IMPORTING
    ...
    "! <p class="shorttext synchronized">Set Texts for line index column</p>
    METHODS set_line_index_column_texts
      CHANGING
        cs_field TYPE lvc_s_fcat.

    "! <p class="shorttext synchronized">Set miscellaneous information for selected rows</p>
    "!
    METHODS set_miscinfo_for_selected_data.
    "! <p class="shorttext synchronized">Set ALV Filters from where condition</p>
    METHODS set_where_as_alv_filter.
    "! <p class="shorttext synchronized">Raise</p>
    METHODS show_no_data_message.

    "! <p class="shorttext synchronized">Steps before selection</p>
    METHODS before_selection
      RAISING
        zcx_dbbr_application_exc.

    "! <p class="shorttext synchronized">Steps after selection</p>
...
CLASS zcl_dbbr_selection_util IMPLEMENTATION.
  METHOD add_hide_flag_column.
    DATA(ls_field) = VALUE lvc_s_fcat( fieldname = zif_dbbr_c_special_out_columns=>hide_flag
  ...
  METHOD add_line_index_column.
    DATA(ls_field) = VALUE lvc_s_fcat( fieldname = zif_dbbr_c_special_out_columns=>line_index ).

    DATA(lv_type) = COND string(
     WHEN mf_group_by = abap_true
     THEN |ZDBBR_NO_OF_LINES|
     ELSE |SYST-TABIX| ).

    DATA(lr_number_of_lines) = CAST cl_abap_elemdescr(
      cl_abap_typedescr=>describe_by_name( lv_type ) ).
    ms_line_index = lr_number_of_lines->get_ddic_field( p_langu = zcl_sat_system_helper=>get_system_language( ) ).
  ...
  METHOD build_full_fieldnames.
    IF    mf_aggregation = abap_true
       OR mf_group_by    = abap_true.
  ...
  METHOD constructor.
    ...
    ms_control_info = VALUE #(
        primary_table    = COND #( WHEN is_selection_data-entity_type = zif_sat_c_entity_type=>table
                                   THEN is_selection_data-entity_id )
    ...
    mo_tabfields          = COND #( WHEN is_selection_data-tabfields IS BOUND
                                    THEN is_selection_data-tabfields->copy( )
                                    ELSE NEW #( ) ).
    mo_tabfields_original = COND #( WHEN is_selection_data-tabfields IS BOUND
                                    THEN is_selection_data-tabfields
                                    ELSE NEW #( ) ).
    mo_tabfields_all      = COND #( WHEN is_selection_data-tabfields_all IS BOUND
                                    THEN is_selection_data-tabfields_all->copy( )
                                    ELSE NEW #( ) ).
    mo_tabfields_all_original = COND #( WHEN is_selection_data-tabfields_all IS BOUND
                                        THEN is_selection_data-tabfields_all
                                        ELSE NEW #( ) ).

    mt_table_to_alias_map = mo_tabfields_all->build_table_to_alias_map( ).
    mt_exclude_function   = is_selection_data-exclude_function.

    mr_s_global_data = CAST zdbbr_global_data( zcl_uitb_data_cache=>get_instance( zif_dbbr_c_report_id=>main )->get_data_ref(
  ...
  METHOD create_default_where_clause.
    ...
    DATA lv_sql_function TYPE zsat_sql_function.
    DATA lt_selfields_and LIKE lt_selfields.

    CLEAR: mt_where,
           mt_or.

    LOOP AT mt_selection_fields ASSIGNING <ls_selfield>
         WHERE     virtual_join_field = abap_false
               AND virtual_element    = abap_false
      ...
      IF     ms_technical_info-search_ignore_case  = abap_true
         AND <ls_selfield>-inttype                CA 'Cg'
         AND <ls_selfield>-lowercase               = abap_true.
        lv_sql_function = zif_sat_c_sql_function=>upper.
      ENDIF.

      " ..... get table field to get alias name
      TRY.
          DATA(lr_selection_field) = mo_tabfields_all->get_field_ref( iv_tabname_alias = <ls_selfield>-tabname_alias
      ...
      IF     <ls_selfield>-datatype      = 'DATS'
         AND <ls_selfield_where>-option <> space
         AND <ls_selfield_where>-low     = space
         AND <ls_selfield_where>-high    = space.
      ...
      LOOP AT mt_selfields_multi ASSIGNING FIELD-SYMBOL(<ls_selfield_multi>)
           WHERE     fieldname     = <ls_selfield>-fieldname
                 AND tabname_alias = <ls_selfield>-tabname_alias
                 AND (    low    IS NOT INITIAL
                       OR high   IS NOT INITIAL
                       OR option IS NOT INITIAL ).
    ...
    LOOP AT mt_multi_or ASSIGNING FIELD-SYMBOL(<ls_or_tuple>).
      ...
      LOOP AT <ls_or_tuple>-values ASSIGNING FIELD-SYMBOL(<ls_or_tuple_value>).
        IF     mt_virtual_join_table_range IS NOT INITIAL
           AND <ls_or_tuple_value>-tabname IN mt_virtual_join_table_range.
          CONTINUE.
        ENDIF.
        ...
        " ...... get table field to get alias name
        TRY.
            lr_selection_field = mo_tabfields_all->get_field_ref( iv_tabname_alias = <ls_or_tuple_value>-tabname_alias
    ...
    mt_where = zcl_sat_where_clause_builder=>create_or_condition( it_or_seltab = mt_or ).
  ENDMETHOD.

  METHOD create_dynamic_table.
    FIELD-SYMBOLS <lt_table> TYPE STANDARD TABLE.
    FIELD-SYMBOLS <lt_table_temp> TYPE STANDARD TABLE.
    ...
    DATA(lr_struct_descr) = cl_abap_structdescr=>get( p_components = CORRESPONDING #( mt_dyntab_components )
                                                      p_strict     = abap_false ).
    TRY.
        " create table type
  ...
  METHOD create_field_catalog.
    ...
    DATA lf_use_num_conversion TYPE abap_bool.
...
**.........key fields will always be included in output table
           OR lr_current_field->is_key        = abap_true.
          lf_create_fieldcat_entry = abap_true.
        ENDIF.
      ELSE.
        IF     lr_current_field->is_formula_field = abap_true
           AND lr_current_field->output_active    = abap_false.
          CONTINUE.
        ENDIF.
      ...
      IF lr_current_field->is_formula_field = abap_false.
        DATA(ls_dtel_infos) = zcl_sat_ddic_repo_access=>get_table_field_info(
      ...
      IF lr_current_field->is_formula_field = abap_true.
        ls_field-emphasize  = COND #( WHEN ms_technical_info-color_formula_fields = abap_true
                                      THEN zif_dbbr_c_global=>c_alv_emphasize-formula_fields_color ).
      ...
      IF lr_current_field->is_virtual_element = abap_true.
        ls_field-emphasize  = COND #( WHEN ms_technical_info-color_cds_calculated_fields = abap_true
      ...
      ELSE. " use conversion exit
        ...
        IF     ls_field-convexit            = space
           AND lr_current_field->is_numeric = abap_true.
      ...
      fill_fcat_quan_curr_field( EXPORTING ir_tabfield       = lr_current_field
                                           ir_tabfields      = mo_tabfields
                                 CHANGING  cv_quantity_field = ls_field-qfieldname
                                           cv_currency_field = ls_field-cfieldname ).

      set_fieldcat_coltexts( EXPORTING ir_field    = lr_current_field
                             CHANGING  cs_fieldcat = ls_field ).

      handle_possible_jumpfield( EXPORTING ir_current_field = lr_current_field
  ...
  METHOD create_group_by_clause.
    ...
    DATA(lt_group_by_fields) = VALUE zdbbr_selfield_itab( FOR selfield IN mt_selection_fields
                                                          WHERE (     group_by      = abap_true
                                                                  AND tabname  NOT IN lt_virtual_join_tab_range )
                                                          ( selfield ) ).
    ...
    LOOP AT lt_group_by_fields ASSIGNING FIELD-SYMBOL(<ls_group_by>).
      IF mf_join_is_active = abap_true.
        ...
        TRY.
            DATA(lr_group_by_field) = mo_tabfields->get_field_ref( iv_tabname_alias = <ls_group_by>-tabname_alias
  ...
  METHOD create_order_by_clause.
    ...
    IF NOT mo_tabfields->checked_field_exists( ).
      RETURN.
    ENDIF.
    ...
    WHILE mo_tabfields->has_more_lines( ).
      ...
      mt_order_by = VALUE #( BASE mt_order_by
                             ( |{ lr_field->sql_fieldname_long } { lv_order_by_type }, | ) ).
    ...
    IF mt_order_by IS NOT INITIAL.
      ...
      <lv_last_field> = replace( val   = <lv_last_field>
                                 regex = ',.*'
                                 with  = space ).
    ENDIF.
  ENDMETHOD.
  ...
  METHOD create_select_clause.
    ...
    WHILE mo_tabfields->has_more_lines( ).
      ...
      IF ms_technical_info-use_reduced_memory = abap_true.
        IF     lr_current_entry->output_active           = abap_false
           AND lr_current_entry->has_active_text_field   = abap_false
           AND lr_current_entry->is_key                  = abap_false
           AND lr_current_entry->needed_for_virtual_join = abap_false
           AND lr_current_entry->needed_for_virtual_elem = abap_false.
          CONTINUE.
        ENDIF.
      ENDIF.
      ...
      IF     lr_selfield IS BOUND
         AND (    lr_selfield->aggregation <> space
               OR lr_selfield->totals       = abap_true ).
        DATA(lv_aggr_function) = COND string(
           WHEN lr_selfield->aggregation <> space
           THEN lr_selfield->aggregation
           ELSE 'SUM' ).
  ...
  METHOD create_text_fieldcat_entry.
    ...
    DATA lt_text_fields TYPE SORTED TABLE OF ty_text_field WITH NON-UNIQUE KEY selection_type table field.

    " get all text field definitions to get the corresponding text field
    lt_text_fields = VALUE #( FOR <ls_field> IN mt_add_texts
                              WHERE (     id_table = ir_selfield->tabname
                                      AND id_field = ir_selfield->fieldname )
    ...
    IF    ls_text_field-selection_type = zif_dbbr_c_text_selection_type=>domain_value
       OR lines( lt_text_fields )      > 1.
      lv_ref_field = 'DDTEXT'.
      lv_ref_table = 'DD07T'.
    ELSE.
    ...
    set_fieldcat_coltexts( EXPORTING ir_field    = ir_selfield
  ...
  METHOD create_util.
    ...
    DATA lf_sql_query TYPE abap_bool.

    IF     is_selection_data-join_def-tables IS NOT INITIAL
       AND is_selection_data-entity_type     <> zif_dbbr_c_selscreen_mode=>query.
    ...
    ELSE.
      CASE is_selection_data-entity_type.
        ...
        WHEN zif_dbbr_c_selscreen_mode=>query.
          IF     is_selection_data-query_string IS NOT INITIAL
             AND is_selection_data-entity_id    IS INITIAL.
            lf_sql_query = abap_true.
          ELSE.
            " .......... SQL queries need a different kind of processing
            SELECT SINGLE @abap_true FROM zdbbr_queryh
    ...
    IF lv_typename IS NOT INITIAL.
      CREATE OBJECT ro_util TYPE (lv_typename)
        EXPORTING is_selection_data = is_selection_data.
  ...
  METHOD determine_checkbox_output.
    ...
    lr_elem_descr->get_ddic_fixed_values( RECEIVING  p_fixed_values = DATA(lt_fix_values)
                                          EXCEPTIONS not_found      = 1
                                                     no_ddic_type   = 2
                                                     OTHERS         = 3 ).
    IF sy-subrc = 0.
      result = xsdbool(     lines( lt_fix_values ) = 2
                        AND line_exists( lt_fix_values[ low = 'X' ] )
                        AND line_exists( lt_fix_values[ option = 'EQ'
                                                        low    = space ] ) ).
    ENDIF.
  ENDMETHOD.
  ...
  METHOD execute_formula_for_lines.
    ...
    zcl_dbbr_screen_helper=>show_progress( iv_text     = |{ TEXT-005 }|
                                           iv_progress = 50 ).
  ...
  METHOD fill_fcat_quan_curr_field.
    ...
    TRY.
        DATA(lr_reference_field) = ir_tabfields->get_field_ref( iv_tabname_alias = ir_tabfield->ref_tab
  ...
  METHOD fill_header.
    cr_dd_doc->add_table( EXPORTING no_of_columns = 2
                                    border        = '0'
                                    width         = '60%'
    ...
    " .. add table content
    lr_table->span_columns( col_start_span = lr_col1
                            no_of_cols     = 2 ).
    lr_table->new_row( ).
    lr_col1->add_text( text         = |{ 'Primary Entity' }|
    ...
    IF is_join_active( ).
      ...
      lr_table->span_columns( col_start_span = lr_col1
                              no_of_cols     = 2 ).
      lr_col1->add_text( text         = 'Secondary Tables'
                         sap_emphasis = cl_dd_document=>strong ).
      lr_table->new_row( ).
  ...
  METHOD get_alv_filter_from_criteria.
    ...
    rt_filter = get_alv_util( )->get_filter_from_criteria( it_criteria       = mt_selection_fields
                                                           it_criteria_multi = mt_selfields_multi ).
  ENDMETHOD.

  METHOD get_alv_util.
    IF mr_alv_util IS INITIAL.
      mr_alv_util = NEW zcl_dbbr_output_alv_util( if_use_live_filter = ms_technical_info-activate_alv_live_filter
  ...
  METHOD get_short_texts.
    ...
    ev_scrtext_m = COND #( WHEN ir_tabfield->alt_medium_text IS NOT INITIAL
                           THEN ir_tabfield->alt_medium_text
                           ELSE ir_tabfield->std_medium_text ).
    ev_scrtext_l = COND #( WHEN ir_tabfield->alt_long_text IS NOT INITIAL
                           THEN ir_tabfield->alt_long_text
                           ELSE ir_tabfield->std_long_text ).

    ev_ddtext = ir_tabfield->field_ddtext.
  ENDMETHOD.

  METHOD get_sql_query.
    " TODO: parameter IF_FOR_CONSOLE is never used (ABAP cleaner)
  ...
  METHOD handle_reduced_memory.
    ...
    lt_has_text_field = VALUE #( FOR f IN lr_t_fields->* WHERE ( has_text_field = abap_true )
                                 ( sign = 'I' option = 'EQ' low = f-alv_fieldname ) ).
  ...
  METHOD init_navigation_breadcrumbs.
    ...
    mr_breadcrumbs_dd->add_table( EXPORTING no_of_columns = 1
                                            border        = '0'
                                            width         = '100%'
                                  IMPORTING table         = DATA(lr_table) ).
    ...
    lr_table->add_column( IMPORTING column = DATA(lr_col1) ).
    lr_table->new_row( ).
    lr_col1->add_text( text         = 'Navigation History'
                       sap_emphasis = cl_dd_document=>strong ).
    lr_table->new_row( ).
    ...
    LOOP AT mt_nav_breadcrumbs ASSIGNING FIELD-SYMBOL(<lv_breadcrumb>).
      IF sy-tabix > 1.
        lr_col1->add_text( text         = ' => '
                           sap_emphasis = cl_dd_area=>strong ).
      ENDIF.
      lr_col1->add_text( text = |{ <lv_breadcrumb> }| ).
    ENDLOOP.
    mr_breadcrumbs_dd->merge_document( ).

    mr_breadcrumbs_dd->display_document( parent        = ir_container
  ...
  METHOD select_data.
    ...
    IF    ms_technical_info-activate_alv_live_filter = abap_true
      ...
      mo_sql_selection = zcl_dbbr_sql_selection=>create( it_select   = mt_select
                                                         it_from     = mt_from
                                                         it_where    = mt_where
  ...
  METHOD set_miscinfo_for_selected_data.
    ...
    FIELD-SYMBOLS <lt_table> TYPE STANDARD TABLE.
    FIELD-SYMBOLS <lt_text_cache> TYPE SORTED TABLE.

    IF mt_add_texts IS INITIAL.
      RETURN.
    ENDIF.

    zcl_dbbr_screen_helper=>show_progress( iv_text     = |{ TEXT-004 }|
                                           iv_progress = 75 ).
    ...
    LOOP AT mt_add_texts ASSIGNING FIELD-SYMBOL(<ls_add_text>).
      ...
      " build select clause
      lt_select = VALUE #( BASE lt_select
      ...
      IF <ls_add_text>-language_field IS NOT INITIAL.
        lt_where = VALUE #(
            BASE lt_where
            ( |{ <ls_add_text>-language_field } = { cl_abap_dyn_prg=>quote(
                                                        zcl_sat_system_helper=>get_system_language( ) ) }| ) ).
      ENDIF.

      TRY.
          SELECT (lt_select)
            FROM (<ls_add_text>-text_table)
            INTO CORRESPONDING FIELDS OF TABLE <lt_text_cache>
            WHERE (lt_where).
      ...
      LOOP AT mt_add_texts ASSIGNING <ls_add_text>.
        ...
        ELSE.
          ...
          IF <lv_text_key2_value> IS ASSIGNED.
            ASSIGN <lt_text_cache>[ (<ls_add_text>-key_field) = <lv_text_key_value>
                                    (<ls_add_text>-key_field2) = <lv_text_key2_value> ] TO FIELD-SYMBOL(<ls_text_value>).
          ELSE.
            ASSIGN <lt_text_cache>[ (<ls_add_text>-key_field) = <lv_text_key_value> ] TO <ls_text_value>.
          ENDIF.
          CHECK sy-subrc = 0.

          " extract text value from found text line
          zcl_dbbr_addtext_helper=>fill_text_field_value( iv_text_field     = <ls_add_text>-text_field
  ...
  METHOD update_selection_for_filter.
    mr_alv_util->build_selection_criteria( IMPORTING et_criteria       = mt_selection_fields
  ...
  METHOD get_sel_count_text.
    ...
    ELSE.
      DATA(lv_max_line_count) = COND #(
        WHEN mv_max_lines_existing IS INITIAL AND iv_filtered_line_count IS NOT INITIAL
        THEN `?`
    ...
    CASE cv_function.
      ...
      WHEN zif_dbbr_c_selection_functions=>change_max_row_count.
        ...
        DATA(lv_max_rows) = CONV sy-tabix(
          zcl_uitb_pgv_factory=>create_single_field_popup( iv_title = |{ 'Set Max Number of Rows'(008) }|
                                                           is_field = VALUE #( fieldname = 'TABIX'
                                                                               tabname   = 'SYST'
      ...
      WHEN zif_dbbr_c_selection_functions=>show_sql_of_select.
        ...
        IF lv_sql IS NOT INITIAL.
          zcl_uitb_abap_code_viewer=>show_code( iv_title  = 'SQL for Current Select'
                                                iv_code   = lv_sql
                                                iv_width  = 900
                                                iv_height = 500
  ...
  METHOD before_selection.
    ...
    zcl_dbbr_addtext_helper=>prepare_text_fields( EXPORTING ir_fields    = mo_tabfields
    ...
    IF mo_formula IS BOUND.
      TRY.
          mo_formula_calculator = zcl_dbbr_formula_calculator=>create( ir_formula        = mo_formula
                                                                       ir_tabfields      = mo_tabfields
  ...
  METHOD execute_function.
    " TODO: parameter IV_FUNCTION is never used (ABAP cleaner)

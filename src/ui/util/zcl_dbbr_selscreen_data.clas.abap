"! <p class="shorttext synchronized">Data Wrapper for Selection Screen</p>
CLASS zcl_dbbr_selscreen_data DEFINITION
  ...
  PUBLIC SECTION.
    ...
    "! <p class="shorttext synchronized">Char 15</p>
    DATA mr_v_selmask_entity_type TYPE REF TO char20 READ-ONLY.
    "! <p class="shorttext synchronized">Table Name</p>
    ...
    "! <p class="shorttext synchronized">Short information about query</p>
    DATA mr_s_query_info TYPE REF TO zdbbr_query_info READ-ONLY.
    "! <p class="shorttext synchronized">Menu Painter: Program interface for dynamic texts</p>
    ...
    "! <p class="shorttext synchronized">Button for DB Browser</p>
    ...
    "! <p class="shorttext synchronized">Stores current join definition for comparison reasons</p>
    ...
    "! <p class="shorttext synchronized">Selection screen resides in multi table mode</p>
    ...
    "! <p class="shorttext synchronized">Clears all custom functions</p>
    METHODS clear_custom_functions.
    "! <p class="shorttext synchronized">Clear all references values</p>
    METHODS clear.
    "! <p class="shorttext synchronized">Clears multi or tuple values</p>

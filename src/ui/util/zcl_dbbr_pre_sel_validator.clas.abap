CLASS zcl_dbbr_pre_sel_validator DEFINITION
  ...
  PRIVATE SECTION.
    ...
    DATA mf_group_by TYPE xsdboolean.
...
CLASS zcl_dbbr_pre_sel_validator IMPLEMENTATION.
  ...
  METHOD determine_selection_status.
    mf_virtual_join = xsdbool(     ms_join_definition IS NOT INITIAL
                               AND line_exists( ms_join_definition-tables[ is_virtual = abap_true ] ) ).

"! <p class="shorttext synchronized">Tree for managing the fields for output/selection/sorting</p>
CLASS zcl_dbbr_field_control_tree DEFINITION
  ...
  PUBLIC SECTION.
    ...
    "! <p class="shorttext synchronized">Create new instance of control tree</p>
    "!
    METHODS constructor
      IMPORTING

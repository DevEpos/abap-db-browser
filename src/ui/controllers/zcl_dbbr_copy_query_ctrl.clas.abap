CLASS zcl_dbbr_copy_query_ctrl DEFINITION
  ...
  PUBLIC SECTION.
    ...
    ALIASES was_copied FOR zif_uitb_screen_controller~was_not_cancelled.
...
CLASS zcl_dbbr_copy_query_ctrl IMPLEMENTATION.
  METHOD constructor.
    ...
    mr_ui_query_name_target->* = is_query_info-query_name.
    mr_ui_query_name->* = mr_ui_query_name_target->*.
    mr_ui_query_desc_target->* = is_query_info-description.
    mr_ui_query_desc->* = mr_ui_query_desc_target->*.
    mr_ui_is_global_target->* = is_query_info-is_global.
    mr_ui_is_global->* = mr_ui_is_global_target->*.
  ENDMETHOD.

  METHOD create_copy.
    DATA(lr_query_copier) = NEW zcl_dbbr_query_copier( iv_src_query_name = mr_ui_query_name->*
    ...
    TRY.
      ...
      CATCH zcx_dbbr_exception INTO DATA(lr_exception).
        lr_exception->show_message( iv_message_type = 'S' ).
        RETURN.
    ENDTRY.
  ENDMETHOD.
  ...
  METHOD zif_uitb_screen_controller~pbo.
    ...
    LOOP AT SCREEN INTO DATA(ls_screen).
      IF    ls_screen-name = zif_dbbr_main_report_var_ids=>c_p_scrnam
         OR ls_screen-name = zif_dbbr_main_report_var_ids=>c_p_scrdec
         OR ls_screen-name = zif_dbbr_main_report_var_ids=>c_p_xglob.
        ls_screen-input = 0.

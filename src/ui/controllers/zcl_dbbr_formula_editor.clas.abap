...
CLASS zcl_dbbr_formula_editor IMPLEMENTATION.
  ...
  METHOD create_dnd_tree_control.
    mo_template_tm = NEW zcl_dbbr_fe_dnd_tree_model( ir_parent        = mo_splitter->get_container( 1 )
  ...
  METHOD save_formula.
    ...
    DATA(lv_formula_descr) = zcl_uitb_pgv_factory=>create_single_field_popup( iv_title = |{ 'Enter Formula name'(008) }|
                                                                              is_field = VALUE #(
                                                                                  tabname   = 'dd01t'
                                                                                  fieldname = 'ddtext'
    ...
    lr_formula_f->save_formula_def( iv_formula_string = lv_formula
  ...
  METHOD set_field_coltexts.
    DATA(lo_popup) = zcl_uitb_pgv_factory=>create_popup( iv_title = 'Go to Page (1.200 of 2000)'
      )->add_fields(
          VALUE #(
  ...
  METHOD show_ddic_value_help.
    ...
    zcl_dbbr_f4_helper=>call_built_in_f4( EXPORTING iv_tablename = 'DD04L'
    ...
    TRY.
      ...
      CATCH zcx_dbbr_formula_exception INTO DATA(lr_exception).
        ...
        IF lr_exception->syntax_message IS NOT INITIAL.
          lr_protocol->add_error( iv_message     = lr_exception->syntax_message

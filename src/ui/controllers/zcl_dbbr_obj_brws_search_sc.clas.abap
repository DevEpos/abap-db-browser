"! <p class="shorttext synchronized">Controller for Object Browser Search input</p>
CLASS zcl_dbbr_obj_brws_search_sc DEFINITION
  ...
  PRIVATE SECTION.
    ...
    DATA mr_s_object_search TYPE REF TO data.
    DATA mr_v_search_type TYPE REF TO zdbbr_obj_browser_mode.

    "! <p class="shorttext synchronized">Handler for closing this dialog</p>
    "!
...
*    CLEAR: mr_v_search_input->*.
    ...
    SET HANDLER on_close_object_search.
  ENDMETHOD.

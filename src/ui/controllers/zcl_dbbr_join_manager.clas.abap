"! <p class="shorttext synchronized">Manager for Join definitions</p>
CLASS zcl_dbbr_join_manager DEFINITION
  ...
  PUBLIC SECTION.
    ...
    "! <p class="shorttext synchronized">Signals to the caller if the join was updated</p>
    METHODS was_updated
      RETURNING
  ...
  PRIVATE SECTION.
    ALIASES and FOR zif_sat_c_selection_condition~and.
    ALIASES or  FOR zif_sat_c_selection_condition~or.

    DATA mo_join TYPE REF TO lcl_join.
    "! <p class="shorttext synchronized">Tree for storing join definition</p>
    ...
    "! <p class="shorttext synchronized">Tree Model: Table of Node Keys</p>
    ...
    "! <p class="shorttext synchronized">Tree Model: Node Key</p>
    DATA mv_current_key_count TYPE i.
    DATA mt_node_map TYPE STANDARD TABLE OF lty_s_node_map WITH KEY node_key.
    "! <p class="shorttext synchronized">Tree Model: Node Key</p>
    DATA ms_new_cond_relat_nodemap TYPE lty_s_node_map.
    DATA mv_new_cond_relationship TYPE i.
    "! <p class="shorttext synchronized">Node of a column tree model</p>
    ...
    "! <p class="shorttext synchronized">Add new AND condition to join table</p>
    METHODS add_and_condition.
    "! <p class="shorttext synchronized">Adds new join table to the tree</p>
    METHODS add_new_join_table.
    "! <p class="shorttext synchronized">Add new OR condition to join table</p>
    METHODS add_or_condition.

    "! <p class="shorttext synchronized">Changes values of given field condition</p>
    METHODS change_field_condition
      IMPORTING
        iv_node_key TYPE tm_nodekey.

    "! <p class="shorttext synchronized">Changes values of given filter condition</p>
    METHODS change_filter_condition
      IMPORTING
        iv_node_key TYPE tm_nodekey.

    "! <p class="shorttext synchronized">Changes values of a given join table</p>
    METHODS change_join_table
      IMPORTING
        iv_node_key TYPE tm_nodekey.

    "! <p class="shorttext synchronized">Change node content</p>
    METHODS change_node.

    "! <p class="shorttext synchronized">Create columns for join tree</p>
    METHODS create_columns
      RAISING
        zcx_uitb_tree_error.

    "! <p class="shorttext synchronized">Create node for field condition</p>
    ...
    "! <p class="shorttext synchronized">Create node for filter condition</p>
    ...
    "! <p class="shorttext synchronized">Create node for join table</p>
    ...
    "! <p class="shorttext synchronized">Create OR Group Node</p>
    METHODS create_or_group_node
      RETURNING
        VALUE(rv_node_key) TYPE tm_nodekey.

    "! <p class="shorttext synchronized">Create Tree to hold tables/conditions</p>
    METHODS create_tree
      IMPORTING
        io_container TYPE REF TO cl_gui_container.

    "! <p class="shorttext synchronized">Deletes all conditions (filter or field)</p>
    ...
    "! <p class="shorttext synchronized">Delete Condition</p>
    METHODS delete_condition.

    "! <p class="shorttext synchronized">Deletes a field condition</p>
    ...
    "! <p class="shorttext synchronized">Deletes a filter condition</p>
    ...
    "! <p class="shorttext synchronized">Deletes the passed node and select next best node</p>
    ...
    "! <p class="shorttext synchronized">Deletes the selected OR-Group</p>
    ...
    "! <p class="shorttext synchronized">Delete selected table</p>
    METHODS delete_table
      IMPORTING
        if_all TYPE abap_bool OPTIONAL.

    "! <p class="shorttext synchronized">Fill tree with existing join definition</p>
    METHODS fill_tree_with_join.

    "! <p class="shorttext synchronized">Fill text content for value items</p>
    METHODS fill_value_item_content
      IMPORTING
        io_node             TYPE REF TO zcl_uitb_ctm_node
        io_filter_condition TYPE REF TO lcl_join_filter.

    "! <p class="shorttext synchronized">Get next free node key</p>
    METHODS get_next_key
      RETURNING
        VALUE(result) TYPE tm_nodekey.

    "! <p class="shorttext synchronized">Handler for when join field condition was created</p>
    METHODS on_created_field_condition
      FOR EVENT created_field_condition OF zcl_dbbr_edit_join_cond_view
      IMPORTING
        es_field.

    "! <p class="shorttext synchronized">Handler for when join filter condition was created</p>
    METHODS on_created_filter_condition
      FOR EVENT created_filter_condition OF zcl_dbbr_edit_join_cond_view
      IMPORTING
        es_filter.

    "! <p class="shorttext synchronized">Handler for when join table was created</p>
    METHODS on_created_join_table
      FOR EVENT created OF zcl_dbbr_edit_join_table_ctrl
      IMPORTING
        es_join_table.

    "! <p class="shorttext synchronized">Handler for when join requests node deletion</p>
    METHODS on_delete_request_from_join
      FOR EVENT request_deletion OF lif_tree_node_events
      IMPORTING
        ev_node_key.

    "! <p class="shorttext synchronized">Handler for node context menu request</p>
    ...
    "! <p class="shorttext synchronized">Handler for menu node selection</p>
    ...
    "! <p class="shorttext synchronized">Handler for tree node double click</p>
    METHODS on_node_double_click
      FOR EVENT node_double_click OF zcl_uitb_ctm_events
      IMPORTING
        ev_node_key.

    "! <p class="shorttext synchronized">Handler for key press on node</p>
    ...
    "! <p class="shorttext synchronized">Test the join definition</p>
    "!
    METHODS test_join.
    "! <p class="shorttext synchronized">Transfers join from tree to structure</p>
    "!
    METHODS transfer_join.

    "! <p class="shorttext synchronized">Updates the OR Group node key for this filter node</p>
    "!
    ...
    "! <p class="shorttext synchronized">Do some further validations for the join</p>
    "!
    METHODS validate_join.
    "! <p class="shorttext synchronized">Changes the alias of the primary table</p>
    "!
    METHODS change_primary_table_alias.

    "! <p class="shorttext synchronized">Update alias of join table and all dependent entities</p>
    "!
    ...
    "! <p class="shorttext synchronized">Updates node/item values in the table</p>
    "!
    METHODS update_node_values
      IMPORTING
        it_nodes_to_update TYPE lty_t_node_to_update.

    "! <p class="shorttext synchronized">Resets the Alias buffer to the initial values of the join</p>
...
CLASS zcl_dbbr_join_manager IMPLEMENTATION.
  METHOD add_and_condition.
    ...
    DATA lv_source_table TYPE tabname.
    ...
    SET HANDLER on_created_filter_condition FOR lo_edit_join_cond_view.
    SET HANDLER on_created_field_condition FOR lo_edit_join_cond_view.

    lo_edit_join_cond_view->show( ).

    IF NOT lo_edit_join_cond_view->was_not_cancelled( ).
      RETURN.
    ENDIF.

    " .. Retrieve the updated information from the view
    lo_edit_join_cond_view->get_updated_condition( IMPORTING es_field_condition  = DATA(ls_field_cond)
                                                             es_filter_condition = DATA(ls_filter_cond) ).

    " .. create the appropriate node
    IF lv_condition_view_mode = zcl_dbbr_edit_join_cond_view=>c_field_mode.
      create_field_condition_node( is_field_cond = ls_field_cond ).
    ELSE.
      create_filter_condition_node( is_filter_condition = ls_filter_cond ).
    ENDIF.
  ENDMETHOD.
  ...
  METHOD add_new_join_table.
    ...
    IF NOT lo_edit_join_table_controller->zif_uitb_screen_controller~was_not_cancelled( ).
      RETURN.
    ENDIF.
  ...
  METHOD add_or_condition.
    ...
    " .. Retrieve the updated information from the view
    lo_edit_join_cond_view->get_updated_condition( IMPORTING es_filter_condition = DATA(ls_filter_cond) ).
  ...
  METHOD change_field_condition.
    ...
    IF NOT lo_edit_join_cond->was_not_cancelled( ).
      RETURN.
    ENDIF.
    ...
    IF NOT lo_join_field->update_field( ls_join_field ).
      RETURN.
    ENDIF.
  ...
  METHOD change_filter_condition.
    ...
    IF NOT lo_join_filter->update_filter( ls_join_filter ).
      RETURN.
    ENDIF.
    fill_value_item_content( io_node             = lo_node
  ...
  METHOD change_join_table.
    ...
    DATA(lo_edit_join_table_ctrl) = NEW zcl_dbbr_edit_join_table_ctrl( is_join_table = ls_current_tab_info
                                                                       if_is_new     = abap_false ).
    lo_edit_join_table_ctrl->zif_uitb_screen_controller~call_screen( ).

    IF NOT lo_edit_join_table_ctrl->zif_uitb_screen_controller~was_not_cancelled( ).
      RETURN.
    ENDIF.
    DATA(ls_updated_tab_info) = lo_edit_join_table_ctrl->get_updated_join_table( ).

    IF NOT lo_join_table->set_tab_info( CORRESPONDING #( ls_updated_tab_info ) ).
      RETURN.
    ENDIF.

    IF ls_updated_tab_info-add_table_alias <> ls_current_tab_info-add_table_alias.
      update_table_alias( iv_old_alias = ls_current_tab_info-add_table_alias
                          iv_new_alias = ls_updated_tab_info-add_table_alias ).
    ENDIF.

    " .. Update field conditions if virtual join was activated
    IF     ls_updated_tab_info-is_virtual = abap_false
       AND ls_current_tab_info-is_virtual = abap_true.
      " .... clear all offset information from associated field conditions
      lo_join_table->clear_offset_from_fields( ).
    ENDIF.

    " .. update the join type
    lo_node->get_item( c_columns-value )->set_text( COND #( WHEN ls_updated_tab_info-is_virtual = abap_true
                                                            THEN |{ 'Virtual'(018) } |
                                                            ELSE || ) &&
                                                    st_join_type_fixvals[
                                                        low = ls_updated_tab_info-join_type ]-ddtext ).
  ...
  METHOD change_primary_table_alias.
    DATA(lv_new_alias) = zcl_uitb_pgv_factory=>create_single_field_popup(
                             ...
                             is_field = VALUE #( tabname   = 'zdbbr_joint'
    ...
    IF     lv_new_alias IS NOT INITIAL
       AND mo_join->mv_primary_entity_alias <> lv_new_alias.
  ...
  METHOD class_constructor.
    ...
    st_join_type_fixvals = lo_join_type_descr->get_ddic_fixed_values( p_langu = 'E' ).
  ENDMETHOD.
  ...
  METHOD constructor.
    ...
    mo_join = NEW #( VALUE #(
                         ...
                         entity_alias  = COND #( WHEN mr_join_def->primary_table_alias IS INITIAL
                                                 THEN zcl_dbbr_entity_alias_util=>create_entity_alias( mr_join_def->primary_table )
                                                 ELSE mr_join_def->primary_table_alias ) ) ).
  ENDMETHOD.

  METHOD create_columns.
    DATA(lo_cols) = mo_join_tree->get_columns( ).
    lo_cols->add_hierarchy_column( iv_colname = c_columns-hier2 ).
    lo_cols->add_column( iv_colname     = c_columns-field
                         iv_width       = 40
                         iv_header_text = 'Field / Description'(002) ).
    lo_cols->add_column( iv_colname     = c_columns-comparator1
                         iv_width       = 15
                         iv_alignment   = cl_item_tree_model=>align_center
                         iv_header_text = 'Comparator'(003) ).
    lo_cols->add_column( iv_colname     = c_columns-value
                         iv_width       = 40
                         iv_header_text = 'Field2 / Value / Join Type'(004) ).
    lo_cols->add_column( iv_colname     = c_columns-comparator2
                         iv_width       = 20
                         iv_alignment   = cl_item_tree_model=>align_center
                         iv_header_text = 'Comparator 2'(005) ).
    lo_cols->add_column( iv_colname     = c_columns-value2
                         iv_width       = 40
                         iv_header_text = 'Value2'(006) ).
  ENDMETHOD.

  METHOD create_content.
    create_control_toolbar( EXPORTING io_parent  = io_container
                                      it_button  = VALUE #( ( function  = c_functions-transfer_data
                                                              icon      = icon_okay
    ...
    mo_toolbar->set_static_ctxmenu( fcode   = c_functions-delete_table
  ...
  METHOD create_field_condition_node.
    DATA(lo_new_field_cond) = NEW lcl_join_field( is_field    = is_field_cond
    ...
    DATA(ls_field_node_map) = VALUE lty_s_node_map( node_key  = lo_new_field_cond->mv_node_key
    ...
    IF mv_new_cond_relationship = cl_tree_model=>relat_last_child.
      mo_join_tree->get_nodes( )->expand_node( iv_node_key       = ms_new_cond_relat_nodemap-node_key
    ...
    lo_join_table->add_field( io_field      = lo_new_field_cond
  ...
  METHOD create_filter_condition_node.
    DATA(lo_new_filter_cond) = NEW lcl_join_filter( is_filter   = is_filter_condition
                                                    iv_table    = ms_new_cond_relat_nodemap-tabname
                                                    iv_alias    = ms_new_cond_relat_nodemap-alias
                                                    iv_node_key = get_next_key( ) ).
    ...
    IF         mo_relat_node IS BOUND
*       mv_new_cond_relationship <> cl_tree_model=>relat_last_child AND
       AND     mo_relat_node->is_folder( )
       AND NOT mo_relat_node->has_children( ).
      CLEAR lv_and_or.
    ENDIF.
    ...
    update_or_group_of_filter( io_filter_node = lo_new_filter_cond_node
    ...
    DATA(ls_field_node_map) = VALUE lty_s_node_map( node_key  = lo_new_filter_cond->mv_node_key
                                                    tabname   = ms_new_cond_relat_nodemap-tabname
                                                    alias     = ms_new_cond_relat_nodemap-alias
...
*.. determine_predecessor_
    lo_join_table->add_filter( io_filter      = lo_new_filter_cond
  ...
  METHOD create_join_table_node.
    ...
    DATA(lo_new_join_table) = NEW lcl_join_table( is_join_table = CORRESPONDING #( is_join_table )
                                                  iv_node_key   = get_next_key( ) ).
    ...
    mo_join_tree->get_nodes( )->add_node(
        ...
        it_item_table     = VALUE #( class = cl_column_tree_model=>item_class_text
                                     ...
                                     ( item_name = c_columns-value
                                       text      = COND #( WHEN is_join_table-is_virtual = abap_true
                                                           THEN |{ 'Virtual'(018) } |
                                                           ELSE || ) &&
    ...
    mo_join_tree->get_nodes( )->add_node( iv_node_key          = lv_node_key
    ...
    " .. expand all nodes of new table node
    mo_join_tree->get_nodes( )->expand_node( iv_node_key       = lo_new_join_table->mv_node_key
                                             if_expand_subtree = abap_true ).
  ...
  METHOD create_or_group_node.
    ...
    IF     mv_new_cond_relationship = cl_tree_model=>relat_next_sibling
       AND lf_first_child           = abap_true.
      CLEAR lv_and_text.
    ENDIF.
    ...
    DATA(ls_or_group_nm) = VALUE lty_s_node_map( node_key  = rv_node_key
    ...
    IF ms_new_cond_relat_nodemap-node_type = c_node_type-table_filter.
      ...
      mo_relat_node->move_node_to( iv_relative_node = rv_node_key
                                   iv_relationship  = cl_tree_model=>relat_first_child ).
      update_or_group_of_filter( io_filter_node   = mo_relat_node
                                 iv_or_group_node = rv_node_key
                                 iv_node_type     = c_node_type-table_filter_or ).
      " .... Now the former AND filter was transferred to an OR Filter, this has to be
  ...
  METHOD create_tree.
    ...
    mo_join_tree = NEW #( ir_parent           = io_container
                          is_hierarchy_header = VALUE treemhhdr( heading = 'Table/Conditions'(001)
                                                                 width   = 60 ) ).

    DATA(lo_events) = mo_join_tree->get_events( ).

    SET HANDLER on_node_double_click     FOR lo_events.
    SET HANDLER on_node_keypress         FOR lo_events.
    SET HANDLER on_node_ctx_menu_request FOR lo_events.
    SET HANDLER on_node_ctx_menu_select  FOR lo_events.
  ...
  METHOD delete_all_conditions.
    " TODO: parameter IO_JOIN_TABLE is never used (ABAP cleaner)
    ...
    CASE is_node_map-node_type.
      ...
      WHEN c_node_type-table_fields.
        ...
        IF     io_node->has_children( )
           AND zcl_dbbr_appl_util=>popup_to_confirm(
      ...
      WHEN c_node_type-table_filters.
        IF     io_node->has_children( )
          ...
          lt_node_type_to_delete = VALUE #( sign   = 'I'
                                            option = 'EQ'
                                            ( low = c_node_type-table_filter )
                                            ( low = c_node_type-table_filter_or )
                                            ( low = c_node_type-or_filter_group ) ).
        ELSE.
          RETURN.
        ENDIF.
    ENDCASE.
  ...
  METHOD delete_condition.
    ...
    CASE <ls_node>-node_type.
      ...
      WHEN c_node_type-table_filter OR
        ...
        delete_filter_condition( io_node       = lo_selected_node
                                 io_join_table = lo_join_table
                                 is_node_map   = <ls_node> ).

      WHEN c_node_type-table_field.
        delete_field_condition( io_node       = lo_selected_node
                                io_join_table = lo_join_table
                                is_node_map   = <ls_node> ).

      WHEN c_node_type-table_fields OR
           c_node_type-table_filters.
        delete_all_conditions( io_node       = lo_selected_node
                               io_join_table = lo_join_table
                               is_node_map   = <ls_node> ).

      WHEN c_node_type-or_filter_group.
        delete_or_group( io_node       = lo_selected_node
                         io_join_table = lo_join_table ).
  ...
  METHOD delete_field_condition.
    ...
    IF     io_node->mv_node_key             = lo_first_child->mv_node_key
       AND lo_parent->get_nr_of_children( ) > 1.
      lo_first_child->get_next_sibling( )->get_item( zcl_uitb_column_tree_model=>c_hierarchy_column
      )->set_text( '' ).
    ENDIF.

    delete_node_and_select_next( io_node     = io_node
  ...
  METHOD delete_node_and_select_next.
    ...
    IF lf_relat_is_sibling = abap_false.
      ...
      IF     ls_new_node_map-node_type = c_node_type-or_filter_group
         AND if_stop_recursion         = abap_false.
        " .... Call the same method again to delete the or group as well
        delete_node_and_select_next( io_node           = lo_next_node
  ...
  METHOD delete_or_group.
    ...
    IF     lo_filters_node->get_nr_of_children( ) = 2
       AND io_node->is_first_child( ).
  ...
  METHOD do_before_dynpro_output.
    io_callback->set_title(
        |{ 'DB Browser - Joins for'(020) } { mo_join->mv_primary_entity } ({ to_lower( mo_join->mv_primary_entity_alias ) })| ).
  ...
  METHOD fill_tree_with_join.
    ...
    LOOP AT <ls_join_def>-tables ASSIGNING FIELD-SYMBOL(<ls_join_table>).
      ...
      LOOP AT <ls_join_table>-field_conditions ASSIGNING FIELD-SYMBOL(<ls_join_field>).
        ...
        create_field_condition_node( is_field_cond = <ls_join_field>
      ...
      DATA lv_previous_and_or TYPE vsconj.
      ...
      LOOP AT <ls_join_table>-filter_conditions ASSIGNING FIELD-SYMBOL(<ls_join_filter>).
        ...
        create_filter_condition_node( is_filter_condition = <ls_join_filter>
                                      if_from_event       = abap_true
  ...
  METHOD fill_value_item_content.
    ...
    DATA lv_value2 TYPE zsat_value.
    ...
    CASE ls_filter-value_type.
      ...
      WHEN zif_sat_c_join_cond_val_type=>typed_input.
        ...
        zcl_sat_data_converter=>convert_selopt_to_disp_format( EXPORTING iv_tabname   = ls_filter-tabname
                                                                         iv_fieldname = ls_filter-fieldname
                                                               CHANGING  cv_value1    = lv_value1
                                                                         cv_value2    = lv_value2 ).
      ...
      WHEN zif_sat_c_join_cond_val_type=>system_value_input.
        ...
        lo_value1_item->set_text( |{ ls_filter-value } | &&
  ...
  METHOD on_created_field_condition.
    ...
    create_field_condition_node( if_from_event = abap_true
  ...
  METHOD on_created_filter_condition.
    ...
    create_filter_condition_node( if_from_event       = abap_true
  ...
  METHOD on_node_ctx_menu_request.
    ...
    IF ls_flags-edit = abap_true.
      er_menu->add_function( fcode = c_functions-edit_condition
    ...
    IF ls_flags-add_and = abap_true OR ls_flags-add_or = abap_true.
      IF ls_flags-add_and = abap_true.
        er_menu->add_function( fcode = c_functions-add_and_condition
                               text  = 'Add AND Condition' ).
      ENDIF.
      IF ls_flags-add_or = abap_true.
        er_menu->add_function( fcode = c_functions-add_or_condition
    ...
    IF ls_flags-delete = abap_true.
      er_menu->add_function( fcode = ls_flags-delete_func
  ...
  METHOD update_or_group_of_filter.
    CHECK    iv_node_type = c_node_type-table_filter
          OR iv_node_type = c_node_type-table_filter_or.
    ...
    ELSE.
      ...
      lo_filter->set_or_group_node( COND #( WHEN iv_or_group_node IS NOT INITIAL
                                            THEN iv_or_group_node
                                            ELSE io_filter_node->get_parent( )->mv_node_key ) ).
    ENDIF.
  ENDMETHOD.

  METHOD update_table_alias.
    DATA(lt_nodes_to_update) = mo_join->update_table_alias( iv_new_alias = iv_new_alias
  ...
  METHOD zif_uitb_gui_command_handler~execute_command.
    TRY.
      ...
      CATCH zcx_sat_validation_exception INTO DATA(lx_validation_error).
        lx_validation_error->print_message( iv_msg_type = 'I' ).
    ENDTRY.
  ENDMETHOD.
ENDCLASS.

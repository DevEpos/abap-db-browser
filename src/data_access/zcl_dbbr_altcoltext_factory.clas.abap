...
CLASS zcl_dbbr_altcoltext_factory IMPLEMENTATION.
  ...
  METHOD find_alternative_texts.
    ...
    SELECT * FROM zdbbr_altcolt
      INTO CORRESPONDING FIELDS OF TABLE rt_alternative_texts
  ...
  METHOD find_alternative_text.
    ...
    SELECT SINGLE * FROM zdbbr_altcolt
      INTO CORRESPONDING FIELDS OF rs_alternative_text

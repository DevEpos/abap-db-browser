"! <p class="shorttext synchronized">Validates token of calculation field</p>
  ...
  METHOD zif_dbbr_token_validator~validate.
    ...
    CASE cs_token-id.
      ...
      WHEN 4.
        ...
        cl_abap_typedescr=>describe_by_name( EXPORTING  p_name         = cs_token-str
                                             RECEIVING  p_descr_ref    = DATA(lr_type_of_form)
    ...
    IF lv_error_string IS NOT INITIAL.
      ...
      RAISE EXCEPTION TYPE zcx_dbbr_fe_stmnt_valid_exc
        EXPORTING textid      = zcx_dbbr_fe_stmnt_valid_exc=>form_def_token_error

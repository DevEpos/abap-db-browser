"! <p class="shorttext synchronized">Calculation of formula fields</p>
...
CLASS zcl_dbbr_formula_calculator IMPLEMENTATION.
  ...
  METHOD create.
    rr_formula_calculator = NEW zcl_dbbr_formula_calculator( ir_formula        = ir_formula
  ...
  METHOD create_subroutine_pool.
    ...
    IF lv_message IS NOT INITIAL.
      zcl_sat_message_helper=>split_string_for_message( EXPORTING iv_string = lv_message
      ...
      RAISE EXCEPTION TYPE zcx_dbbr_exception
        EXPORTING textid = zcx_dbbr_exception=>general_error
                  msgv1  = lv_msgv1
                  msgv2  = lv_msgv2
                  msgv3  = lv_msgv3
                  msgv4  = lv_msgv4.

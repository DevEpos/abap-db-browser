...
CLASS ltcl_fe_validator DEFINITION FINAL
  FOR TESTING RISK LEVEL HARMLESS DURATION SHORT.

  PRIVATE SECTION.
    METHODS test_all_keywords              FOR TESTING.
    METHODS test_val_correct_form          FOR TESTING.
    METHODS test_undefined_formfield       FOR TESTING.
    METHODS test_invalid_keyword           FOR TESTING.
    METHODS test_unknown_keyword           FOR TESTING.
    METHODS test_no_executable_code        FOR TESTING.
    METHODS test_tokenization_error        FOR TESTING.
    METHODS test_def_keyword_template      FOR TESTING.
    METHODS test_text_keyword_template     FOR TESTING.
    METHODS test_icon_keyword_template     FOR TESTING.
    METHODS test_icon_tt_keyowrd_tmplt     FOR TESTING.
    METHODS test_set_icon_tt_keyword_tmplt FOR TESTING.
    METHODS test_set_row_color_tmplt       FOR TESTING.
    METHODS test_set_cell_color_tmplt      FOR TESTING.

    METHODS create_test_tabfields
      RETURNING
...
CLASS ltcl_fe_validator IMPLEMENTATION.
  ...
  METHOD create_test_tabfields.
    ...
    zcl_dbbr_tabfield_builder=>create_tabfields( iv_tablename     = 'COEP'

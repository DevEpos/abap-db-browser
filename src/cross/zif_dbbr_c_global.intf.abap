"! <p class="shorttext synchronized">Global constants</p>
INTERFACE zif_dbbr_c_global
  ...
  CONSTANTS c_default_numeric_type TYPE dd04l-rollname VALUE 'ZDBBR_DEC17_5' ##NO_TEXT.
  "! Dummy Table for formula fields
  CONSTANTS c_formula_dummy_table TYPE tabname VALUE '-FORMULA-' ##NO_TEXT.
  ...
  CONSTANTS:
    ...
    BEGIN OF c_options,
      default     TYPE c LENGTH 1 VALUE space ##NO_TEXT,
      i           TYPE c LENGTH 1 VALUE 'I' ##NO_TEXT,
      e           TYPE c LENGTH 1 VALUE 'E' ##NO_TEXT,
      bt          TYPE c LENGTH 2 VALUE 'BT' ##NO_TEXT,
      nb          TYPE c LENGTH 2 VALUE 'NB' ##NO_TEXT,
      eq          TYPE c LENGTH 2 VALUE 'EQ' ##NO_TEXT,
      ne          TYPE c LENGTH 2 VALUE 'NE' ##NO_TEXT,
      gt          TYPE c LENGTH 2 VALUE 'GT' ##NO_TEXT,
      ge          TYPE c LENGTH 2 VALUE 'GE' ##NO_TEXT,
      lt          TYPE c LENGTH 2 VALUE 'LT' ##NO_TEXT,
      le          TYPE c LENGTH 2 VALUE 'LE' ##NO_TEXT,
      cp          TYPE c LENGTH 2 VALUE 'CP' ##NO_TEXT,
      np          TYPE c LENGTH 2 VALUE 'NP' ##NO_TEXT,
      is_null     TYPE c LENGTH 2 VALUE 'IN' ##NO_TEXT,
      is_not_null TYPE c LENGTH 2 VALUE 'NN' ##NO_TEXT,
      n           TYPE c LENGTH 40 VALUE 'NB,NE' ##NO_TEXT,
    END OF c_options.
  ...
  CONSTANTS c_container TYPE scrfname VALUE 'RESULT_LIST' ##NO_TEXT.

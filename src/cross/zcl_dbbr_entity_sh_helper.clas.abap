...
CLASS zcl_dbbr_entity_sh_helper IMPLEMENTATION.
  ...
  METHOD select_and_fill_result.
    ...
    DATA lt_result TYPE STANDARD TABLE OF zdbbr_entity_sh_result.
    DATA lt_package_selopt TYPE RANGE OF devclass.
    ...
    CASE mv_entity_type.
      ...
      WHEN zif_sat_c_entity_type=>query.
        SELECT query_name  AS entity_id,
               description AS ddtext
          FROM zdbbr_queryh
    ...
    IF lt_result IS NOT INITIAL.
      ...
      CALL FUNCTION 'F4UT_RESULTS_MAP'
        EXPORTING source_structure = 'ZDBBR_ENTITY_SH_RESULT'
        TABLES    shlp_tab         = ct_shlp_tab
                  record_tab       = ct_records
                  source_tab       = lt_result
        CHANGING  shlp             = cs_shlp

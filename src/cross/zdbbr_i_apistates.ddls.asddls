  ...
  as select from cls_assignment as cls
{
  ...
  cast( cls.sobj_name as tabname )     as ObjectName,
  case
...
// Add Custom Fields Releases object (C0) from custom fields registry
union select from cfd_w_cds as CustomFieldRegistry
{
  'DDLS'                               as ObjectType,
  cds_view_name                        as ObjectName,
  '4'                                  as FilterValue,
  cast( 'RELEASED' as abap.char(184) ) as APIState
}
where

CLASS zcl_dbbr_help_repository DEFINITION
  ...
  PUBLIC SECTION.
    ...
    "! <p class="shorttext synchronized">Shows the help for the supplied help index</p>
...
CLASS zcl_dbbr_help_repository IMPLEMENTATION.
  ...
  METHOD call_rollname_help.
    ...
    CALL FUNCTION 'HELP_OBJECT_SHOW'
      EXPORTING  dokclass         = c_doku_class-data_element
                 dokname          = lv_object
      TABLES     links            = lt_links
  ...
  METHOD call_general_help.
    ...
    CALL FUNCTION 'HELP_OBJECT_SHOW'
      EXPORTING  dokclass         = c_doku_class-general_text
  ...
  METHOD help_show_test.
    zcl_uitb_popup_help_viewer=>create( iv_title        = 'Test Help Viewer'
                                        ir_html_content = NEW zcl_uitb_html_content(
                                        )->add_heading( iv_level = 2
                                                        iv_text  = 'Definition'
                                        )->start_table(
                                        )->start_table_row(
                                        )->add_table_header_cell( 'Column 1'
                                        )->add_table_header_cell( 'Column 2'
                                        )->add_table_header_cell( 'Column 3'
                                        )->add_table_header_cell( 'Column 4'
                                        )->add_table_header_cell( 'Column 5'
                                        )->add_table_header_cell( 'Column 6'
                                        )->add_table_header_cell( 'Column 7'
                                        )->end_table_row(
                                        )->start_table_row(
                                        )->add_table_body_cell( 'Data 1'
                                        )->add_table_body_cell( 'Data 2'
                                        )->add_table_body_cell( 'Data 3'
                                        )->add_table_body_cell( 'Data 4'
                                        )->add_table_body_cell( 'Data 5'
                                        )->add_table_body_cell( 'Data 6'
                                        )->add_table_body_cell( 'Data 7'
                                        )->end_table_row(
                                        )->end_table( )
    )->show( ).
  ENDMETHOD.
